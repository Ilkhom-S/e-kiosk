...
QStringList NetworkManager::getConnectionTemplates() const {
    ...
    if (!m_Directory) {
        qCritical() << "NetworkManager::getConnectionTemplateNames: m_Directory is null";
        return nameList;
    }
...
bool NetworkManager::createDialupConnection(const SDK::PaymentProcessor::SConnection &aConnection,
    ...
    if (!m_Directory) {
        qCritical() << "NetworkManager::createDialupConnection: m_Directory is null";
        return false;
    }
...
bool NetworkManager::removeDialupConnection(const SDK::PaymentProcessor::SConnection &aConnection) {
    ...
    if (!m_Directory) {
        qCritical() << "NetworkManager::removeDialupConnection: m_Directory is null";
        return false;
    }
