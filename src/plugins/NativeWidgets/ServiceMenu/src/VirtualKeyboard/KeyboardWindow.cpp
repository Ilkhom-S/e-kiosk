...
void KeyboardWindow::initialize()
{
    ...
    mAltKeyMap["KEY_BRACKETLEFT"] =
        VirtualButton(Qt::Key_BracketLeft, QString::fromUtf8("х"), Qt::Key_BraceLeft, QString::fromUtf8("Х"));
    mAltKeyMap["KEY_BRACKETRIGHT"] =
        VirtualButton(Qt::Key_BracketRight, QString::fromUtf8("ъ"), Qt::Key_BraceRight, QString::fromUtf8("Ъ"));
...
void KeyboardWindow::onButtonClicked()
{
    ...
    QKeyEvent keyPress(QEvent::KeyPress, button.getKey(mShifted), mShifted ? Qt::ShiftModifier : Qt::NoModifier,
                       button.getText(mShifted));
