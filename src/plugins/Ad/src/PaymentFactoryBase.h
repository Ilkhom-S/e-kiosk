...
#pragma region SDK::PaymentProcessor::IPaymentFactory interface
    ...
    virtual bool restorePayment(SDK::PaymentProcessor::IPayment *aPayment,
    ...
    //---------------------------------------------------------------------------
    // Конвертация переданного платежа к типу aTargetType, поддерживаемо этой фабрикой. В случае ошибка
    // возвращает false
