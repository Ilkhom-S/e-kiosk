...
namespace
{
	...
	REGISTER_PLUGIN(SDK::Plugin::makePath(PPSDK::Application, PPSDK::CComponents::RemoteClient,
...
//------------------------------------------------------------------------------
void AdRemotePlugin::setConfiguration(const QVariantMap& aParameters){Q_UNUSED(aParameters)}
