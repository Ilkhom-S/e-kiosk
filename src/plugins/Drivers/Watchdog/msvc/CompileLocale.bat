...
lrelease "..\src\locale\watchdogs_tg.ts" "%TC_LIB_DIR%\Hardware\common_tg.ts" -qm "%~1\%~2_tg.qm"
lrelease "..\src\locale\watchdogs_uz.ts" "%TC_LIB_DIR%\Hardware\common_uz.ts" -qm "%~1\%~2_uz.qm"
