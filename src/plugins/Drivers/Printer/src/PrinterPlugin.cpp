...
CUSTOM_PRINTER_PLUGIN(LibUSBCustom_TG2480H, customParameters, Custom TG2480H)
...
SINGLE_PRINTER_PLUGIN(LibUSBCustom_VKP80, customVkP80Parameters, Custom VKP - 80)
