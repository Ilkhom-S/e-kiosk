...
TParameterList COMParameters() {
    ...
    return TParameterList() << SPluginParameter(CHardwareSDK::SystemName, false, PortPT::Name, QString(), QVariant(),
                            ...
                            << SPluginParameter(CHardware::Port::COM::BaudRate, false, PortPT::COM::BaudRate, QString(),
                                                QVariant(),
                                                QStringList() << "4800" << "9600" << "14400" << "19200" << "38400"
                                                              << "57600" << "115200")
                            << SPluginParameter(CHardware::Port::COM::Parity, false, PortPT::COM::Parity, QString(),
                                                "0", QStringList() << "0" << "1" << "2")
                            << SPluginParameter(CHardware::Port::COM::ByteSize, false, PortPT::COM::ByteSize, QString(),
                                                "8", QStringList() << "8" << "7")
                            << SPluginParameter(CHardware::Port::COM::RTS, false, PortPT::COM::RTS, QString(), "1",
                                                QStringList() << "0" << "1" << "2" << "3")
                            << SPluginParameter(CHardware::Port::COM::DTR, false, PortPT::COM::DTR, QString(), "0",
                                                QStringList() << "0" << "1" << "2");
}
