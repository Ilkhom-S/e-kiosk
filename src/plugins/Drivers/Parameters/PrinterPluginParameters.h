...
SDK::Plugin::SPluginParameter setLineSpacing(
...
/// Петля.
SDK::Plugin::SPluginParameter setLoopEnabled(const QString &aOptionalTranslation = "",
                                             bool aAuto = true);
...
SDK::Plugin::SPluginParameter setLeftReceiptAction(const QString &aParameter,
                                                   bool aRetract,
                                                   bool aPush,
