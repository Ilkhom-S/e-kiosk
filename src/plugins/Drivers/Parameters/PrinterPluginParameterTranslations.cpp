...
const char NotTakenReceipt[] =
    QT_TRANSLATE_NOOP("PrinterParameters", "PrinterParameters#not_taken_receipt");
const char PreviousReceipt[] =
    QT_TRANSLATE_NOOP("PrinterParameters", "PrinterParameters#previous_receipt");
const char PreviousAndNotTakenReceipts[] =
    QT_TRANSLATE_NOOP("PrinterParameters", "PrinterParameters#previous_and_not_taken_receipts");
const char Codepage[] = QT_TRANSLATE_NOOP("PrinterParameters", "PrinterParameters#codepage");
const char Loop[] = QT_TRANSLATE_NOOP("PrinterParameters", "PrinterParameters#loop");
