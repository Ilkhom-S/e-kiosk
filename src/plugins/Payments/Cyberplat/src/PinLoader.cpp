...
//------------------------------------------------------------------------------
Response* PinLoader::createResponse(const SDK::PaymentProcessor::CyberPlat::Request& aRequest,
...
void PinLoader::onLoadPinList()
{
	...
	SDK::PaymentProcessor::CyberPlat::RequestSender http(mPaymentFactoryBase->getNetworkTaskManager(),
