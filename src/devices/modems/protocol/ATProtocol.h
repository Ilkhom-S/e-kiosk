...
{
    const auto regExpBalance     = "([0-9]{1,5}[.][0-9]{1,2}|[0-9]{1,5}[,][0-9]{1,2}|[-][0-9]{1,5}[.][0-9]{1,2}|[-][0-9]{1,5}[,][0-9]{1,2})";
...
private:
    ...
    bool sendCommand(QByteArray dataRequest, bool getResponse, int timeResponse, QByteArray& dataResponse, int timeSleep);
    bool isOpened();
