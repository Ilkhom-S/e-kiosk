            ...
            if (QJsonParseError::NoError == error.error)
            {
                foreach (auto jsonFieldVariant, result)
                {
                    ...
                    if (jsonField.contains("security"))
                    {
                        ...
                        {
                            field.security.insert(SProviderField::Default, security.value("default").toString());
                        }
                        if (security.contains("display"))
                        {
                            field.security.insert(SProviderField::Display, security.value("display").toString());
                        }
                        ...
                        {
                            field.security.insert(SProviderField::Printer, security.value("printer").toString());
                        }
                    }
