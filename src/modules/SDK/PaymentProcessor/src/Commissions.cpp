    ...
    namespace PaymentProcessor {
        ...
        Commission Commission::fromSettings(const TPtree &aSettings) {
            ...
            QString minChargeValue =
                aSettings.get<QString>("<xmlattr>.min_charge", QString::number(CCommissions::MinChargeValue)).trimmed();
            commission.mMinCharge = minChargeValue.isEmpty() ? CCommissions::MinChargeValue : minChargeValue.toDouble();

            QString maxChargeValue =
                aSettings.get<QString>("<xmlattr>.max_charge", QString::number(CCommissions::MaxChargeValue)).trimmed();
            ...
            commission.mBase =
                (aSettings.get<QString>("<xmlattr>.base", "amount_all").toLower() == "amount") ? Amount : AmountAll;
