/* @file Переименование путей плагинов для учета типа взаимодействия с устройством. */
...
public:
    RenamePluginPath() {
        ...
        insert("Common.Driver.CardReader.SamaraTicket",
               "Common.Driver.CardReader.External.SamaraTicket");
        insert("Common.Driver.CoinAcceptor.ccTalk coin acceptor - base functional",
               "Common.Driver.CoinAcceptor.COM.ccTalk");
        insert("Common.Driver.CoinAcceptor.ccTalk coin acceptor with 2-stage enabling",
               "Common.Driver.CoinAcceptor.COM.ccTalk.ComplexEnabling");
        ...
        insert("Common.Driver.FiscalRegistrator.ATOL FR",
               "Common.Driver.FiscalRegistrator.COM.ATOL");
        insert("Common.Driver.FiscalRegistrator.PayPPU-700K",
               "Common.Driver.FiscalRegistrator.COM.ATOL.PayPPU700K");
        insert("Common.Driver.FiscalRegistrator.PayVKP-80K",
               "Common.Driver.FiscalRegistrator.COM.ATOL.PayVKP80K");
        insert("Common.Driver.FiscalRegistrator.CommonIncotex",
               "Common.Driver.FiscalRegistrator.COM.Incotex");
        insert("Common.Driver.FiscalRegistrator.CommonPRIM",
               "Common.Driver.FiscalRegistrator.COM.PRIM");
        insert("Common.Driver.FiscalRegistrator.PresenterPRIM",
               "Common.Driver.FiscalRegistrator.COM.PRIM.Presenter");
        insert("Common.Driver.FiscalRegistrator.EjectorPRIM",
               "Common.Driver.FiscalRegistrator.COM.PRIM.Ejector");
        insert("Common.Driver.FiscalRegistrator.CommonShtrih",
               "Common.Driver.FiscalRegistrator.COM.Shtrih");
        insert("Common.Driver.FiscalRegistrator.RetractorShtrih",
               "Common.Driver.FiscalRegistrator.COM.Shtrih.Ejector");
        insert("Common.Driver.FiscalRegistrator.Shtrih-M Shtrih Kiosk-FR-K",
               "Common.Driver.FiscalRegistrator.COM.Shtrih.Kiosk");
        insert("Common.Driver.FiscalRegistrator.Shtrih-M Yarus-01K",
               "Common.Driver.FiscalRegistrator.COM.Shtrih.Yarus01K");
        insert("Common.Driver.FiscalRegistrator.CommonSpark",
               "Common.Driver.FiscalRegistrator.COM.SPARK");
        insert("Common.Driver.FiscalRegistrator.Multisoft MStar-TUP-K based on OPOS",
               "Common.Driver.FiscalRegistrator.OPOS.Multisoft");
        ...
        insert("Common.Driver.Printer.Citizen CBM-1000II",
               "Common.Driver.Printer.COM.POS.CitizenCBM1000II");
        insert("Common.Driver.Printer.Citizen CPP-8001",
               "Common.Driver.Printer.COM.POS.CitizenCPP8001");
        insert("Common.Driver.Printer.Citizen CT-S310II",
               "Common.Driver.Printer.COM.POS.CitizenCTS310II");
        insert("Common.Driver.Printer.Citizen CTS-2000",
               "Common.Driver.Printer.COM.POS.CitizenCTS2000");
        insert("Common.Driver.Printer.Citizen PPU-231",
               "Common.Driver.Printer.COM.POS.CitizenPPU231");
        ...
        insert("Common.Driver.Printer.Sunphor POS58IV",
               "Common.Driver.Printer.System.Sunphor.POS58IV");
        ...
        insert("Common.Driver.Scanner.OPOS Metrologic Scanner",
               "Common.Driver.Scanner.OPOS.Honeywell");
