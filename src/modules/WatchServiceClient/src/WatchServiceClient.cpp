...
bool WatchServiceClient::subscribeOnCommandReceived(QObject *aObject) {
    return aObject->connect(
        this, SIGNAL(onCommandReceived(const QString &, const QString &, const QString &, const QStringList &)),
...
bool WatchServiceClient::subscribeOnCloseCommandReceived(QObject *aObject) {
    return connect(this, SIGNAL(onCloseCommandReceived()), aObject, SLOT(onCloseCommandReceived()),
                   Qt::UniqueConnection);
}
...
bool WatchServiceClient::subscribeOnModuleClosed(QObject *aObject) {
    return connect(this, SIGNAL(onModuleClosed(const QString &)), aObject, SLOT(onModuleClosed(const QString &)),
                   Qt::UniqueConnection);
}
