/* @file DEPRECATED - See include/Hardware/CashAcceptors/CCTalkCashAcceptor.h instead.
...
All NEW code should include <Hardware/CashAcceptors/CCTalkCashAcceptor.h>.
*/
