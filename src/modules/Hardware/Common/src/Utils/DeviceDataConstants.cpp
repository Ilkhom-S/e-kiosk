...
namespace Companion {
const char MaxBurstPacketAmount[] = "ep_companion_max_burst_packet_amount";
const char Attributes[] = "ep_companion_attributes";
const char BytesPerInterval[] = "ep_companion_bytes_per_interval";
} // namespace Companion
} // namespace Endpoint
} // namespace Interface
} // namespace Config
...
const char CurrentDate[] = "current_date";
...
const char NonFiscalDocuments[] = "non_fiscal_documents";
...
const char ActivizationDate[] = "activization_date";
const char FreeActivizations[] = "free_activizations";
} // namespace EKLZ

/// ФП.
namespace FM {
const char FreeSessions[] = "free_sessions";
const char Firmware[] = "firmware";
} // namespace FM
...
namespace FS {
const char SerialNumber[] = "serial_number";
const char ValidityData[] = "validity_data";
const char DifferenceDT[] = "difference_dt";
const char Version[] = "version";
...
const char PowerSupply[] = "power_supply";
} // namespace Sub
} // namespace Watchdogs
