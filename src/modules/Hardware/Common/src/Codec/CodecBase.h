...
struct SCharData
{
	...
	bool operator==(const SCharData& aData) const { return (character == aData.character) && (main == aData.main); }
};
...
public:
	...
	void add(char aCode, const QString& aCharacter, bool aMain = true) { append(aCode, SCharData(aCharacter, aMain)); }

	void add(char aCode, const char* aCharacter, bool aMain = true) { append(aCode, SCharData(aCharacter, aMain)); }
