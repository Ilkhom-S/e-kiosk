...
const char ModelName[] = QT_TRANSLATE_NOOP("CommonParameters", "CommonParameters#model_name");
const char OPOSName[] = QT_TRANSLATE_NOOP("CommonParameters", "CommonParameters#opos_name");
const char RequiredResource[] =
