...
/// Команды.
namespace Commands {
extern const char LockInitialize[];
extern const char UnLockInitialize[];
extern const char GetSerialNumber[];
extern const char GetStatus[];
extern const char IdentifyIC[];
extern const char IdentifyRF[];
extern const char SetMCReadingMode[];
extern const char ReadMSData[];
extern const char PowerReset[];
extern const char ADPUT0[];
extern const char ADPUT1[];
} // namespace Commands
