...
namespace EMV
{
    Application AidList[] = {Application("A0000000031010", "VISA"),   Application("A0000000041010", "MC"),
                             Application("A0000004320001", "PRO100"), Application("A0000000032010", "VISA Electron"),
                             Application("A0000000046000", "Cirrus"), Application("A00000002501", "AMEX")};
} // namespace EMV
