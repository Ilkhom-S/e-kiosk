...
struct SUnpackedData : SUnpackedDataBase {
    ...
    SUnpackedData()
        : command(0), commandResult(0), FiscalMemoryNearEnd(false), FiscalMemoryEnd(false),
          EKLZNearEnd(false), EKLZError(false), TechnoMode(false), PrinterError(false),
          CutterOff(false), PaperEnd(false), OfflineError(false), Register(0) {}
};
...
const QByteArray MSoftVendor =
    "\x8C\xE3\xAB\xEC\xE2\xA8\xE1\xAE\xE4\xE2\x20\x91\xA8\xE1\xE2\xA5\xAC\xA7";
} // namespace Identification
