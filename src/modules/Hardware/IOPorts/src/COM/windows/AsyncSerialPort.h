...
namespace CAsyncSerialPort
{
	...
	const QVector<int> NoLogErrors =
		QVector<int>() << ERROR_SUCCESS		   /// Операция успешно завершена
	...
	const QVector<int> DisappearingErrors = QVector<int>() << ERROR_FILE_NOT_FOUND /// Не удается найти указанный файл
