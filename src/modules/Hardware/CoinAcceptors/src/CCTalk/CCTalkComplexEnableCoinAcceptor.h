/* @file DEPRECATED - See include/Hardware/CoinAcceptors/CCTalkComplexEnableCoinAcceptor.h instead.
...
All NEW code should include <Hardware/CoinAcceptors/CCTalkComplexEnableCoinAcceptor.h>.
*/
