...
namespace CCCTalk
{
	...
	public:
		ErrorData()
		{
			...
			add(27, DeviceStatusCode::Error::Unknown, false,
				"Games overload"); // будут поддержаны при реализации этих устройств
			add(28, DeviceStatusCode::Error::Unknown, false,
			...
			add(253, BillAcceptorStatusCode::OperationError::Unknown, false,
				"Data block request (note ?)"); // "not yet used", запрос каких-то данных от хоста
			add(254, BillAcceptorStatusCode::Reject::UserDefined, false,
