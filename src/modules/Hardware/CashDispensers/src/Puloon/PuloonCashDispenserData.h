    ...
    class CDeviceCodeSpecification : public CommonDeviceCodeSpecification {
      public:
        CDeviceCodeSpecification() {
            ...
            addStatus('\x3A', DeviceStatusCode::Error::Unknown,
            ...
            addStatus('\x4B', DeviceStatusCode::Error::Unknown,
    ...
    class CRejectingSpecification : public CDescription<char> {
      public:
        CRejectingSpecification() {
            ...
            append('\x03',
                   "The banknote are not normally passing on the check sensor because of fast consequential pickup");
            append('\x00',
                   "The banknote are not normally passing on the check sensor because of fast consequential pickup");
