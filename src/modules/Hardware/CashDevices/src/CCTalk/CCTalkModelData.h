...
namespace CCCTalk {
    ...
    class CVendorData : public CSpecification<QString, SVendorData> {
      ...
      private:
        void add(const QString &aVendorID, const QString &aVendor, const QString &aShortVendor = "",
                 bool aComplexEnabling = false);
    };
    ...
    const char DeviceNamePostfix[] =
        "cash device, unknown model based on ccTalk protocol"; /// Оконание названия устройства известного производителя
                                                               /// по умолчанию.
    ...
    class CModelDataBase : public CSpecification<QString, TModelData> {
      ...
      protected:
        void add(const QString &aVendorId, const QString &aModelId, uchar aFault = 0, uchar aError = 0,
