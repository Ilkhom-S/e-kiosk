...
//--------------------------------------------------------------------------------
void CVendorData::add(const QString &aVendorID,
                      const QString &aVendor,
                      const QString &aShortVendor,
                      bool aComplexEnabling) {
    append(aVendorID, SVendorData(aVendor, aShortVendor, aComplexEnabling));
}

//--------------------------------------------------------------------------------
void CModelDataBase::add(const QString &aVendorId,
                         const QString &aModelId,
                         uchar aFault,
                         uchar aError,
...
//--------------------------------------------------------------------------------
QString CModelDataBase::getData(const QByteArray &aVendorID,
                                const QByteArray &aModelID,
                                SModelData &aModelData) {
