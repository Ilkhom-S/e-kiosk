...
namespace CSTAR
{
	...
	namespace Commands
	{
		...
		template <class T>
		inline QString int2ASCII(T aValue, int aDigits)
		{
		...
		const QByteArray WriteMemorySwitches =
			QByteArray::fromRawData("\x1B\x1D\x23\x57\x30\x30\x30\x30\x30\x0A\x00", 11);	/// Записать мем-свичи.
