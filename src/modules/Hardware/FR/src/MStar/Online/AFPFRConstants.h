...
namespace CAFPFR
{
    ...
    namespace FRInfo
    {
        ...
        const SData LastFiscalDT =
            SData(5, TAnswerTypes() << EAnswerTypes::Date << EAnswerTypes::Time,
        ...
        const SData FFDFS =
            SData(16, TAnswerTypes() << EAnswerTypes::Int << EAnswerTypes::Int, "FFD FS"); /// Код версии ФФД ФН.
        ...
        class CData : public CDataBase
        {
          public:
            CData()
            {
                ...
                add(GetPrinterStatus, TAnswerTypes() << Int,
                ...
                add(GetFSStatus, TAnswerTypes() << Int << Int << Int << Int << Int << Date << Time << String << Int
                                                << String << Int << Date << Int << Int);
                add(GetOFDStatus, TAnswerTypes() << Int << Int << Int << Int << Date << Time, 3 * 1000);
                add(GetFiscalizationTotal, TAnswerTypes()
                                               << Date << Time << FInt << FInt << FInt << Int << Int << FInt << FInt);
