        ...
        class CData : public CSpecification<int, SData>
        {
          public:
            CData()
            {
                ...
                flags110.add(
                    19, "xx01xxxx",
                    "taxes and other options"); /// Дополнительные возможности по использованию нулевой ставки налогов
                ...
                flags110.add(25, "00001000",
                             "backfeed"); /// Величина обратного движения бумаги после обрезки чека (только 110)
                flags110.add(
                    26, "01xxxxxx",
                    "X,Z-report and paper spending"); /// X- и Z-отчеты и расход бумаги после отрезки чека (только 110)
