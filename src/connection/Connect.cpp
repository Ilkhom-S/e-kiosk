...
int ConnectionPart::createNewDialupConnection(QString conName, QString devName, QString phone, QString login, QString pass)
{
...
bool ConnectionPart::restartWindows(bool restart)
{
    ...
    if(restart) COMMAND_INIT = EWX_REBOOT;
