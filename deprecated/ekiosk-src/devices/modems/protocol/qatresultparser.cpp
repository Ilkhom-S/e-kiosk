...
/*!
    ...
    \brief The QAtResultParser class provides support for parsing the response
   to AT modem commands and unsolicited notifications.
...
/*!
    ...
    \brief The Node class provides access to a generic value parsed from an AT
   command list.

    Instances of this class are returned from the QAtResultParser::readList()
   function.
...
/*!
    ...
    Returns the number contained within this node, or return zero if node not a
   number.
...
/*!
    ...
    Returns the first number in a range that is contained within this node;
   otherwise returns zero if not a range.
...
/*!
    ...
    Returns the last number in a range that is contained within this node;
   otherwise returns zero if not a range.
...
/*!
    ...
    Returns the string contained within this node; otherwise returns null if not
   a string.
...
/*!
    ...
    Returns the list contained within this node, or returns an empty list if
   this node does not contain a list.
