...
public:
    ...
    Q_INVOKABLE
    void gotoPageInputAccount(QString serviceName) { emit emitGotoPageInputAccount(serviceName); }

    Q_INVOKABLE
    void
    gotoPageInsertNominal(QString account, QString accountDesign, QString prvId, QString prvName) {
    ...
    Q_INVOKABLE
    void userInfoCheck(QString account, QString prvId) { emit emitUserInfoCheck(account, prvId); }
