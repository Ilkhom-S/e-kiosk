...
#pragma region IHardwareDatabaseUtils interface
    ...
    virtual bool setDeviceParam(const QString &aDeviceConfigName, const QString &aParamName,
    ...
    virtual bool addDeviceStatus(const QString &aDeviceConfigPath, SDK::Driver::EWarningLevel::Enum aErrorLevel,
