...
#pragma region IHardwareDatabaseUtils interface
    ...
    /// существует.
    virtual bool isDeviceParam_Exists(const QString &aDeviceConfigName);
...
#pragma region IPaymentDatabaseUtils interface
    ...
    virtual bool addPaymentNote(qint64 aPayment,
                                const SDK::PaymentProcessor::SNote &aNote);
    virtual bool addPaymentNote(qint64 aPayment,
    ...
    getPayments(const QSet<SDK::PaymentProcessor::EPaymentStatus::Enum> &aStates);
    ...
    perform_Encashment(const QVariantMap &aParameters);
