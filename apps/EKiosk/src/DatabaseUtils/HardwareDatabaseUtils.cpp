...
bool DatabaseUtils::setDeviceParam(const QString &aDeviceConfigName, const QString &aParamName,
    ...
    QString queryMessage =
        QString("INSERT OR REPLACE INTO `device_param` (`name`, `value`, `fk_device_id`) VALUES (:param_name, "
...
bool DatabaseUtils::addDeviceStatus(const QString &aDeviceConfigName, SDK::Driver::EWarningLevel::Enum aErrorLevel,
    ...
    QString queryMessage = QString("SELECT `level`, `description` FROM `device_status` WHERE `fk_device_id` = (SELECT "
