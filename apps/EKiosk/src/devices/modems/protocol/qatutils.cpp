...
static ushort const cp437ToUnicode[256] = {
    ...
    0x000e, 0x000f, 0x0010, 0x0011, 0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x0019, 0x001c, 0x001b,
    0x007f, 0x001d, 0x001e, 0x001f, 0x0020, 0x0021, 0x0022, 0x0023, 0x0024, 0x0025, 0x0026, 0x0027, 0x0028, 0x0029,
    ...
    0x007e, 0x001a, 0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00e4, 0x00e0, 0x00e5, 0x00e7, 0x00ea, 0x00eb, 0x00e8, 0x00ef,
    ...
    0x03b1, 0x00df, 0x0393, 0x03c0, 0x03a3, 0x03c3, 0x03bc, 0x03c4, 0x03a6, 0x0398, 0x03a9, 0x03b4, 0x221e, 0x03c6,
...
static unsigned char const cp437FromUnicode[256] = {
    ...
    0x13, 0x14, 0x15, 0x16, 0x17, 0x18, 0x19, 0x7f, 0x1b, 0x1a, 0x1d, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25,
    ...
    0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0x1c, '?',  '?',  '?',  '?',  '?',
    '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',
    '?',  '?',  '?',  '?',  '?',  '?',  '?',  '?',  0xff, 0xad, 0x9b, 0x9c, '?',  0x9d, '?',  0x15, '?',  '?',  0xa6,
    0xae, 0xaa, '?',  '?',  '?',  0xf8, 0xf1, 0xfd, '?',  '?',  '?',  0x14, 0xfa, '?',  '?',  0xa7, 0xaf, 0xac, 0xab,
    '?',  0xa8, '?',  '?',  '?',  '?',  0x8e, 0x8f, 0x92, 0x80, '?',  0x90, '?',  '?',  '?',  '?',  '?',  '?',  '?',
    0xa5, '?',  '?',  '?',  '?',  0x99, '?',  '?',  '?',  '?',  '?',  0x9a, '?',  '?',  0xe1, 0x85, 0xa0, 0x83, '?',
...
static ushort const cp850ToUnicode[256] = {
    ...
    0x007e, 0x001a, 0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00e4, 0x00e0, 0x00e5, 0x00e7, 0x00ea, 0x00eb, 0x00e8, 0x00ef,
    0x00ee, 0x00ec, 0x00c4, 0x00c5, 0x00c9, 0x00e6, 0x00c6, 0x00f4, 0x00f6, 0x00f2, 0x00fb, 0x00f9, 0x00ff, 0x00d6,
    0x00dc, 0x00f8, 0x00a3, 0x00d8, 0x00d7, 0x0192, 0x00e1, 0x00ed, 0x00f3, 0x00fa, 0x00f1, 0x00d1, 0x00aa, 0x00ba,
    0x00bf, 0x00ae, 0x00ac, 0x00bd, 0x00bc, 0x00a1, 0x00ab, 0x00bb, 0x2591, 0x2592, 0x2593, 0x2502, 0x2524, 0x00c1,
    0x00c2, 0x00c0, 0x00a9, 0x2563, 0x2551, 0x2557, 0x255d, 0x00a2, 0x00a5, 0x2510, 0x2514, 0x2534, 0x252c, 0x251c,
    0x2500, 0x253c, 0x00e3, 0x00c3, 0x255a, 0x2554, 0x2569, 0x2566, 0x2560, 0x2550, 0x256c, 0x00a4, 0x00f0, 0x00d0,
    0x00ca, 0x00cb, 0x00c8, 0x0131, 0x00cd, 0x00ce, 0x00cf, 0x2518, 0x250c, 0x2588, 0x2584, 0x00a6, 0x00cc, 0x2580,
    0x00d3, 0x00df, 0x00d4, 0x00d2, 0x00f5, 0x00d5, 0x00b5, 0x00fe, 0x00de, 0x00da, 0x00db, 0x00d9, 0x00fd, 0x00dd,
    0x00af, 0x00b4, 0x00ad, 0x00b1, 0x2017, 0x00be, 0x00b6, 0x00a7, 0x00f7, 0x00b8, 0x00b0, 0x00a8, 0x00b7, 0x00b9,
...
static unsigned char const cp850FromUnicode[256] = {
    ...
    };

// Compact mapping table for converting Unicode 0x0100 - 0xFFFF into IBM850.
static ushort const cp850MappingInput[] = {
    0x0110, 0x0131, 0x0192, 0x2017, 0x2022, 0x203c, 0x203e, 0x2190, 0x2191, 0x2192, 0x2193, 0x2194, 0x2195, 0x21a8,
    0x221f, 0x2302, 0x2500, 0x2502, 0x250c, 0x2510, 0x2514, 0x2518, 0x251c, 0x2524, 0x252c, 0x2534, 0x253c, 0x2550,
    0x2551, 0x2554, 0x2557, 0x255a, 0x255d, 0x2560, 0x2563, 0x2566, 0x2569, 0x256c, 0x2580, 0x2584, 0x2588, 0x2591,
    0x2592, 0x2593, 0x25a0, 0x25ac, 0x25b2, 0x25ba, 0x25bc, 0x25c4, 0x25cb, 0x25d8, 0x25d9, 0x263a, 0x263b, 0x263c,
    0x2640, 0x2642, 0x2660, 0x2663, 0x2665, 0x2666, 0x266a, 0x266c, 0xff01, 0xff02, 0xff03, 0xff04, 0xff05, 0xff06,
    ...
    0xff5b, 0xff5c, 0xff5d, 0xff5e, 0xffe8, 0xffe9, 0xffea, 0xffeb, 0xffec, 0xffed, 0xffee};
static unsigned char const cp850MappingOutput[] = {
    0xd1, 0xd5, 0x9f, 0xf2, 0x07, 0x13, 0xee, 0x1b, 0x18, 0x1a, 0x19, 0x1d, 0x12, 0x17, 0x1c, 0x7f, 0xc4, 0xb3, 0xda,
    0xbf, 0xc0, 0xd9, 0xc3, 0xb4, 0xc2, 0xc1, 0xc5, 0xcd, 0xba, 0xc9, 0xbb, 0xc8, 0xbc, 0xcc, 0xb9, 0xcb, 0xca, 0xce,
    0xdf, 0xdc, 0xdb, 0xb0, 0xb1, 0xb2, 0xfe, 0x16, 0x1e, 0x10, 0x1f, 0x11, 0x09, 0x08, 0x0a, 0x01, 0x02, 0x0f, 0x0c,
    0x0b, 0x06, 0x05, 0x03, 0x04, 0x0d, 0x0e, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b, 0x2c,
    0x2d, 0x2e, 0x2f, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f,
...
/*!
        Returns the text codec for the GSM character set identifier \a
   gsmCharset. The returned object should not be deleted.

        The following standard GSM character sets from 3GPP TS 27.007 are
   recognized:

        \table
                \row \o \c GSM \o 7-bit default GSM alphabet.  There may be some
   loss of information where multiple Unicode characters map to the same 7-bit
   encoding.
                \row \o \c HEX \o Hex encoding of the 7-bit default GSM
   alphabet.
                \row \o \c UCS2 \o Hex encoding of UCS-2.
                \row \o \c IRA \o International reference alphabet (i.e. ASCII).
                \row \o \c PCCPxxx \o PC character set code page \c xxx.  Code
   pages 437 and 850 are guaranteed to be supported.  Other code pages depend
   upon the codecs installed with QTextCodec.
                \row \o \c PCDN \o PC Danish/Norwegian character set (same as \c
   PCCP850).
                \row \o \c UTF-8 \o 8-bit encoding of Unicode.
                \row \o \c 8859-n \o ISO 8859 Latin-n character set.
                \row \o \c 8859-C \o ISO 8859 Latin/Cyrillic character set (same
   as \c 8859-5).
                \row \o \c 8859-A \o ISO 8859 Latin/Arabic character set (same
   as \c 8859-6).
                \row \o \c 8859-G \o ISO 8859 Latin/Greek character set (same as
   \c 8859-7).
                \row \o \c 8859-H \o ISO 8859 Latin/Hebrew character set (same
   as \c 8859-8).
        \endtable

        This implementation also supports the following character sets, beyond
   those mandated by 3GPP TS 27.007:

        \table
                \row \o \c gsm-noloss \o 7-bit default GSM alphabet, with no
   loss of information.
                \row \o \c xxx \o Any codec \c xxx that is supported by
...
/*!
        ...
        sequences in octal rather than the default of hexadecimal; otherwise
   returns false.
...
/*!
        Decodes \a value according to the cell broadcast data coding scheme \a
   dcs. The \a value is assumed to have been parsed by nextString() and be
