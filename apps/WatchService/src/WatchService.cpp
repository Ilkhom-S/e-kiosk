...
QString WatchService::translateError(QProcess::ProcessError aError)
{
	...
	case QProcess::Timedout:
		return QString("The last waitFor...() function timed out. The state of QProcess is unchanged, and you can try "
					   "calling waitFor...() again.");

	case QProcess::WriteError:
		return QString("An error occurred when attempting to write to the process. For example, the process may not be "
