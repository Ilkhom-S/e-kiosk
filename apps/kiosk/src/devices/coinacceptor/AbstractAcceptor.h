#ifndef ABSTRACTACCEPTOR_H
#define ABSTRACTACCEPTOR_H
...
namespace AcceptorErrors
{
    enum Enum
    {
        ...
        /// Валюта не поддерживается (настройки terminal.xml и прошивка валидатора не совпадают)
        WrongCurrency = 2,
