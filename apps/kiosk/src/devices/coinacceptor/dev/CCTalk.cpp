	...
	if (devicesCreated)
	{
		...
		if (serialPort->open(QIODevice::ReadWrite))
		{
			...
			if (!serialPort->setFlowControl(QSerialPort::NoFlowControl))
				return false;
			//            if (!serialPort->setCharIntervalTimeout(AcceptorConstants::Microcoin_CharTimeOut)) return
			//            false;
	...
	do
	{
		...
		if (nak || busy)
		{
			toDebug(QString("ccTalk: %1 in answer, %2")
						.arg(nak ? "NAK" : "BYSY", (busyNAKRepeat <= CCTalkConstruct::MaxBusyNAKRepeats)
	...
	while (events_in_queue > 0)
	{
		...
		else
		{
			...
			case CCTalkConstruct::States::ValidationTimeout:
				this->sendStatusTo(CCtalkStatus::Errors::ValidationTimeout, QString("ValidationTimeout"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::CreditSensorTimeout:
				this->sendStatusTo(CCtalkStatus::Errors::CreditSensorTimeout, QString("CreditSensorTimeout"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::SorterOptoTimeout:
				this->sendStatusTo(CCtalkStatus::Errors::SorterOptoTimeout, QString("SorterOptoTimeout"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::SecondCloseCoinError:
				this->sendStatusTo(CCtalkStatus::Errors::SecondCloseCoinError, QString("SecondCloseCoinError"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::AcceptGateNotReady:
				this->sendStatusTo(CCtalkStatus::Errors::AcceptGateNotReady, QString("AcceptGateNotReady"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::CreditSensorNotReady:
				this->sendStatusTo(CCtalkStatus::Errors::CreditSensorNotReady, QString("CreditSensorNotReady"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;
			...
			case CCTalkConstruct::States::RejectCoinNotCleared:
				this->sendStatusTo(CCtalkStatus::Errors::RejectCoinNotCleared, QString("RejectCoinNotCleared"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::ValidationSensorNotReady:
				this->sendStatusTo(CCtalkStatus::Errors::ValidationSensorNotReady, QString("ValidationSensorNotReady"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::CreditSensorBlocked:
				this->sendStatusTo(CCtalkStatus::Errors::CreditSensorBlocked, QString("CreditSensorBlocked"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::SorterOptoBlocked:
				this->sendStatusTo(CCtalkStatus::Errors::SorterOptoBlocked, QString("SorterOptoBlocked"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::CreditSequenceError:
				this->sendStatusTo(CCtalkStatus::Errors::CreditSequenceError, QString("CreditSequenceError"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::CoinGoingBackwards:
				this->sendStatusTo(CCtalkStatus::Errors::CoinGoingBackwards, QString("CoinGoingBackwards"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;
			...
			case CCTalkConstruct::States::RejectSensorBlocked:
				this->sendStatusTo(CCtalkStatus::Errors::RejectSensorBlocked, QString("RejectSensorBlocked"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;
			...
			case CCTalkConstruct::States::AcceptGateOpenNotClosed:
				this->sendStatusTo(CCtalkStatus::Errors::AcceptGateOpenNotClosed, QString("AcceptGateOpenNotClosed"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::AcceptGateClosedNotOpen:
				this->sendStatusTo(CCtalkStatus::Errors::AcceptGateClosedNotOpen, QString("AcceptGateClosedNotOpen"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;

			case CCTalkConstruct::States::DataBlockRequest:
				this->sendStatusTo(CCtalkStatus::Errors::DataBlockRequest, QString("DataBlockRequest"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;
			...
			case CCTalkConstruct::States::UnspecifiedAlarmCode:
				this->sendStatusTo(CCtalkStatus::Errors::UnspecifiedAlarmCode, QString("UnspecifiedAlarmCode"));
				this->setBoolingDlgState(false); /*qDebug() << "----Returning----"; return 0;*/
				break;
			}
		}
