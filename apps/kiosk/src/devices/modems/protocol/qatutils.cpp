...
QByteArray QGsmHexCodec::name() const { return QByteArray("gsm-hex"); }

int QGsmHexCodec::mibEnum() const { return 61239; }

QString QGsmHexCodec::convertToUnicode(const char *in, int length,
...
QByteArray QGsmHexCodec::convertFromUnicode(const QChar *in, int length,
                                            ConverterState *) const {
  QByteArray buf;
  while (length-- > 0) {
...
QByteArray QUcs2HexCodec::name() const { return "ucs2-hex"; }

int QUcs2HexCodec::mibEnum() const { return 61240; }

QString QUcs2HexCodec::convertToUnicode(const char *in, int length,
                                        ConverterState *) const {
  QString str;
  int nibble = 0;
  int value = 0;
...
QByteArray QUcs2HexCodec::convertFromUnicode(const QChar *in, int length,
                                             ConverterState *) const {
  QByteArray buf;
  while (length-- > 0) {
    uint ch = in->unicode();
...
static ushort const cp437ToUnicode[256] = {
    ...
    0x0012, 0x0013, 0x0014, 0x0015, 0x0016, 0x0017, 0x0018, 0x0019, 0x001c,
    0x001b, 0x007f, 0x001d, 0x001e, 0x001f, 0x0020, 0x0021, 0x0022, 0x0023,
    ...
    0x007e, 0x001a, 0x00c7, 0x00fc, 0x00e9, 0x00e2, 0x00e4, 0x00e0, 0x00e5,
    ...
    0x00df, 0x0393, 0x03c0, 0x03a3, 0x03c3, 0x03bc, 0x03c4, 0x03a6, 0x0398,
...
static unsigned char const cp437FromUnicode[256] = {
    ...
    0x18, 0x19, 0x7f, 0x1b, 0x1a, 0x1d, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23,
    ...
    '?',  '?',  0xa6, 0xae, 0xaa, '?',  '?',  '?',  0xf8, 0xf1, 0xfd, '?',
    '?',  '?',  0x14, 0xfa, '?',  '?',  0xa7, 0xaf, 0xac, 0xab, '?',  0xa8,
    '?',  '?',  '?',  '?',  0x8e, 0x8f, 0x92, 0x80, '?',  0x90, '?',  '?',
    '?',  '?',  '?',  '?',  '?',  0xa5, '?',  '?',  '?',  '?',  0x99, '?',
    '?',  '?',  '?',  '?',  0x9a, '?',  '?',  0xe1, 0x85, 0xa0, 0x83, '?',
    0x84, 0x86, 0x91, 0x87, 0x8a, 0x82, 0x88, 0x89, 0x8d, 0xa1, 0x8c, 0x8b,
    '?',  0xa4, 0x95, 0xa2, 0x93, '?',  0x94, 0xf6, '?',  0x97, 0xa3, 0x96,
    0x81, '?',  '?',  0x98};
...
QByteArray QCodePage437Codec::name() const { return "IBM437"; }
...
int QCodePage437Codec::mibEnum() const { return 437; }
...
static unsigned char const cp850FromUnicode[256] = {
    ...
    };

// Compact mapping table for converting Unicode 0x0100 - 0xFFFF into IBM850.
static ushort const cp850MappingInput[] = {
    0x0110, 0x0131, 0x0192, 0x2017, 0x2022, 0x203c, 0x203e, 0x2190, 0x2191,
    0x2192, 0x2193, 0x2194, 0x2195, 0x21a8, 0x221f, 0x2302, 0x2500, 0x2502,
    0x250c, 0x2510, 0x2514, 0x2518, 0x251c, 0x2524, 0x252c, 0x2534, 0x253c,
    0x2550, 0x2551, 0x2554, 0x2557, 0x255a, 0x255d, 0x2560, 0x2563, 0x2566,
    0x2569, 0x256c, 0x2580, 0x2584, 0x2588, 0x2591, 0x2592, 0x2593, 0x25a0,
    0x25ac, 0x25b2, 0x25ba, 0x25bc, 0x25c4, 0x25cb, 0x25d8, 0x25d9, 0x263a,
    0x263b, 0x263c, 0x2640, 0x2642, 0x2660, 0x2663, 0x2665, 0x2666, 0x266a,
    0x266c, 0xff01, 0xff02, 0xff03, 0xff04, 0xff05, 0xff06, 0xff07, 0xff08,
    ...
    0xff5a, 0xff5b, 0xff5c, 0xff5d, 0xff5e, 0xffe8, 0xffe9, 0xffea, 0xffeb,
    0xffec, 0xffed, 0xffee};
static unsigned char const cp850MappingOutput[] = {
    0xd1, 0xd5, 0x9f, 0xf2, 0x07, 0x13, 0xee, 0x1b, 0x18, 0x1a, 0x19, 0x1d,
    0x12, 0x17, 0x1c, 0x7f, 0xc4, 0xb3, 0xda, 0xbf, 0xc0, 0xd9, 0xc3, 0xb4,
    0xc2, 0xc1, 0xc5, 0xcd, 0xba, 0xc9, 0xbb, 0xc8, 0xbc, 0xcc, 0xb9, 0xcb,
    0xca, 0xce, 0xdf, 0xdc, 0xdb, 0xb0, 0xb1, 0xb2, 0xfe, 0x16, 0x1e, 0x10,
    0x1f, 0x11, 0x09, 0x08, 0x0a, 0x01, 0x02, 0x0f, 0x0c, 0x0b, 0x06, 0x05,
    0x03, 0x04, 0x0d, 0x0e, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28,
    ...
    0x7d, 0x7e, 0xb3, 0x1b, 0x18, 0x1a, 0x19, 0xfe, 0x09};
...
QByteArray QCodePage850Codec::name() const { return "IBM850"; }
...
int QCodePage850Codec::mibEnum() const { return 2009; }

QString QCodePage850Codec::convertToUnicode(const char *in, int length,
                                            ConverterState *) const {
  QString str;
  while (length-- > 0)
...
QByteArray QCodePage850Codec::convertFromUnicode(const QChar *in, int length,
                                                 ConverterState *) const {
  QByteArray result;
  unsigned int ch;
  char *out;
...
/*!
   ...
   returns false.
        ...
        \sa setOctalEscapes()
*/
bool QAtUtils::octalEscapes() { return octalEscapesFlag; }
...
/*!
        ...
        \sa octalEscapes()
*/
void QAtUtils::setOctalEscapes(bool value) { octalEscapesFlag = value; }
