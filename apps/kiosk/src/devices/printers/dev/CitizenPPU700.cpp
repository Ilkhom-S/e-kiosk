...
bool CitizenPPU700_PRINTER::OpenPrinterPort() { return openPort(); }
...
bool CitizenPPU700_PRINTER::isEnabled(CMDCitizenPPU700::SStatus &s_status,
                                      int &status) {
  //    int status = 0;
...
bool CitizenPPU700_PRINTER::getStatus(int &aStatus,
  ...
  } else if (s_status.Failures.Unrecoverable || s_status.Failures.CRC ||
             s_status.Failures.DetectionPresenter || s_status.Error) {
...
bool CitizenPPU700_PRINTER::getState(char aStatusType,
                                     CMDCitizenPPU700::SStatus &aStatus) {
  ...
  if (this->sendCommand(commandPacket, true, 200, respData, answerPacket, 0)) {
    ...
    case CMDCitizenPPU700::Constants::Status::Printer: {
      aStatus.Offline =
          getBit(answer, CMDCitizenPPU700::Positions::Answer::Offline);
      break;
    }
    case CMDCitizenPPU700::Constants::Status::Offline: {
      aStatus.CoverOpen =
          getBit(answer, CMDCitizenPPU700::Positions::Answer::CoverOpen);
      aStatus.PaperOut =
          getBit(answer, CMDCitizenPPU700::Positions::Answer::PaperOut);
      aStatus.Error =
          getBit(answer, CMDCitizenPPU700::Positions::Answer::Error);
      break;
    }
    case CMDCitizenPPU700::Constants::Status::Errors: {
      aStatus.Failures.DetectionPresenter = getBit(
          answer,
          CMDCitizenPPU700::Positions::Answer::Errors::DetectionPresenter);
      ...
      aStatus.Failures.Unrecoverable = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::Errors::Unrecoverable);
      break;
    }
    case CMDCitizenPPU700::Constants::Status::Paper: {
      aStatus.Paper.End =
          getBit(answer, CMDCitizenPPU700::Positions::Answer::Paper::End);
      aStatus.Paper.InPresenter = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::Paper::InPresenter);
      aStatus.Paper.NearEndSensor1 = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::Paper::NearEndSensor1);
      aStatus.Paper.NearEndSensor2 = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::Paper::NearEndSensor2);
      break;
    }
    case CMDCitizenPPU700::Constants::Status::ErrorDetails1: {
      aStatus.Failures.CoverOpen =
          getBit(answer,
                 CMDCitizenPPU700::Positions::Answer::ErrorDetails1::CoverOpen);
      aStatus.Failures.HeadOverheat = getBit(
          answer,
          CMDCitizenPPU700::Positions::Answer::ErrorDetails1::HeadOverheat);
      aStatus.Failures.LowVoltage = getBit(
          answer,
          CMDCitizenPPU700::Positions::Answer::ErrorDetails1::LowVoltage);
      aStatus.Failures.HighVoltage = getBit(
          answer,
          CMDCitizenPPU700::Positions::Answer::ErrorDetails1::HighVoltage);
      break;
    }
    case CMDCitizenPPU700::Constants::Status::ErrorDetails2: {
      aStatus.Failures.Memory = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::ErrorDetails2::Memory);
      aStatus.Failures.CRC = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::ErrorDetails2::CRC);
      aStatus.Failures.Presentor =
          getBit(answer,
                 CMDCitizenPPU700::Positions::Answer::ErrorDetails2::Presentor);
      aStatus.Failures.CPU = getBit(
          answer, CMDCitizenPPU700::Positions::Answer::ErrorDetails2::CPU);
      break;
    }
    default: {
      result = false;
...
bool CitizenPPU700_PRINTER::isItYou() {
  ...
  cmd.push_back(
      CMDCitizenPPU700::PrinterCommandModelParam); // Узнаем модель принтера
...
void CitizenPPU700_PRINTER::getSpecialCharecters(QByteArray &printText) {
  ...
  if (smallChek) {
    ...
    fontTypeDoubleWidth_start.push_back(
        CMDCitizenPPU700::PrinterCommandFirstByte);
    fontTypeDoubleWidth_start.push_back(
        CMDCitizenPPU700::PrinterFontCommandSecondByte);
...
bool CitizenPPU700_PRINTER::printImageI(const QString &aPixelString,
                                        uchar aWidth, bool aNeedRegisterLogo) {
  QByteArray cmd;
...
bool CitizenPPU700_PRINTER::registerLogo(const QString &aPixelString,
                                         uchar aWidth) {
