        ...
        switch (aStatusType) {
            ...
            case CMDCitizenPPU700::Constants::Status::ErrorDetails1: {
                ...
                aStatus.Failures.HeadOverheat = getBit(
                    answer, CMDCitizenPPU700::Positions::Answer::ErrorDetails1::HeadOverheat);
...
void CitizenPPU700_PRINTER::dispense() {
    ...
    if (!this->sendCommand(cmd, false, 0, respData, answer, 50)) return;
}
...
bool CitizenPPU700_PRINTER::initialize() {
    ...
    if (!this->sendCommand(cmd, false, 0, respData, answer, 0)) return false;
...
bool CitizenPPU700_PRINTER::printImageI(const QString& aPixelString, uchar aWidth,
