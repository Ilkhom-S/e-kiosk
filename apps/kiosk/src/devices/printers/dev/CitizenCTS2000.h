...
const char PrinterCommandStatusFirstByte =
    '\x10'; /// Первая часть команды Status.
const char PrinterCommandStatusSecondByte =
    '\x04'; /// Вторая часть команды Status.
...
const char PrinterCommandGetIDSecondByte =
    '\x49'; /// Вторая часть команды identification.
...
const char PrinterCommandInitializeFirstByte =
    '\x1B'; /// Первая часть команды инициализации.
const char PrinterCommandInitializeSecondByte =
    '\x40'; /// Вторая часть команды инициализации.

const char PrinterCommandCodeTableFirstByte =
    '\x1B'; /// Первая часть команды установки кодировки.
const char PrinterCommandCodeTableSecondByte =
    '\x74'; /// Вторая часть команды установки кодировки.
...
const char PrinterCommandImageRegSecondByte =
    '\x2A'; /// Второй байт команды регистрации картинки
const char PrinterCommandImagePrintSecondByte =
    '\x2F'; /// Второй байт команды печати картинки
...
const char PrinterFontCommandSecondByte =
    '\x21'; /// Второй байт команды установки шрифта принтера
