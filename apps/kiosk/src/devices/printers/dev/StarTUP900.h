...
const uchar PresenterAutoPushCmdSecondByte =
    0x16; /// Вторая часть команды PresenterAutoPush.
const uchar PresenterAutoPushCmdThirdByte =
    0x31; /// Третья часть команды PresenterAutoPush.

const uchar PrinterSetFontCmdSecondByte =
    0x69; /// Вторая часть команды SetFont.

const uchar PrinterCommandSetLeftMarginSecondByte =
    0x6C; /// Вторая часть команды установки левой границы.

const uchar PrinterCommandLogoFirstByte =
    0x1B; /// Первая часть команд, связанных с логотипом
const uchar PrinterCommandLogoSecondByte =
    0x1C; /// Вторая часть команд, связанных с логотипом
const uchar PrinterCommandRegLogoThirdByte =
    0x71; /// Третья часть команды регистрации логотипа
const uchar PrinterCommandPrintLogoThirdByte =
    0x70; /// Третья часть команды печати логотипа
...
const uchar PrinterCmdSetBoldSecondByte =
    0x45; /// Второй байт команды установки жирного шрифта
const uchar PrinterCmdCancelBoldSecondByte =
    0x46; /// Второй байт команды отмены жирного шрифта

const uchar PrinterCmdDoubleHeightSecondByte =
    0x68; /// Второй байт команды двойной высоты шрифта
const uchar PrinterCmdDoubleWidthSecondByte =
    0x57; /// Второй байт команды двойной ширины шрифта
const uchar PrinterCmdUnderlineSecondByte =
    0x2D; /// Второй байт команды подчеркнутого шрифта
