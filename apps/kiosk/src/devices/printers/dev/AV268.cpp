...
bool AV268_PRINTER::OpenPrinterPort() { return openPort(); }
...
void AV268_PRINTER::getSpecialCharecters(QByteArray& printText) {
    ...
    printText.replace(QString("%1%2%3")
                          .arg(CScharsetParam::OpenTagDelimiter, CScharsetParam::FontTypeBold,
    ...
    printText.replace(QString("%1%2%3")
                          .arg(CScharsetParam::OpenTagDelimiter, CScharsetParam::FontTypeItalic,
                               CScharsetParam::CloseTagDelimiter)
                          .toUtf8(),
                      asciiNull());
    printText.replace(QString("%1%2%3%4")
    ...
    printText.replace(QString("%1%2%3")
                          .arg(CScharsetParam::OpenTagDelimiter, CScharsetParam::FontTypeUnderLine,
                               CScharsetParam::CloseTagDelimiter)
                          .toUtf8(),
                      asciiNull());
    printText.replace(QString("%1%2%3%4")
    ...
    printText.replace(QString("%1%2%3")
                          .arg(CScharsetParam::OpenTagDelimiter, CScharsetParam::ProbelCount,
                               CScharsetParam::CloseTagDelimiter)
                          .toUtf8(),
                      probel);
    ...
    printText.replace(QString("%1%2%3%4")
                          .arg(CScharsetParam::OpenTagDelimiter, CScharsetParam::StarCount,
                               CScharsetParam::CloseTagDelimiter)
                          .toUtf8(),
                      star);
}
