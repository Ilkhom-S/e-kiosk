...
const uchar PrinterStatusCommandFirstByte =
    0x1B; /// Статус принтера первый байт
const uchar PrinterStatusCommandSecondByte =
    0x76; /// Статус принтера второй байт
const uchar PrinterInitCommandSecondByte =
    0x40; /// Инициализация принтера второй байт
const uchar PrinterCutCommandSecondByte = 0x6D; /// Отрез бумаги второй байт
const uchar PrinterFeedCommandByte = 0x0A;      /// Прокрутка бумаги
const uchar PrinterSetFontSecondByte =
    0x21; /// Второй байт команды комплексной установки шрифта

const uchar PrinterHighFontSecondByte =
    0x10; /// Второй байт установки высокого шрифта
const uchar PrinterBaldFontSecondByte =
    0x45; /// Второй байт установки жирного шрифта
const uchar PrinterUnderlineFontSecondByte =
    0x2D; /// Второй байт установки подчеркнутого шрифта
const uchar PrinterDWFontSecondByte =
    0x21; /// Второй байт установки шрифта с двойной шириной
const uchar PrinterDWFontThirdByte =
    0x20; /// Третий байт установки шрифта с двойной шириной
...
const uchar PrinterHeadOpenError =
    0x08; /// Дверца термоголовки(открыта). 0- норма
...
const QString DeviceName = "Phoenix PHX-POG";
}; // namespace CMDPhoenix
...
public:
  Phoenix_PRINTER(QObject *parent = 0);
