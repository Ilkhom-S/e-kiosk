...
/// Внутренний механизм не приведен в рабочее положение - рычаги не опущены/подняты, др.
...
class BasePrinterDevices : public QThread {
  ...
  public:
    ...
    bool sendCommand(QByteArray dataRequest, bool getResponse, int timeResponse, bool& respOk,
...
/// - каждый положительный бит маски сравнивается с соответствующим битом аргумента
/// Возвращается true, если все 1-биты совпали
