...
void ClassValidator::setValidator(QString name) {
  ...
  if (validatorName == ValidatorModel::CashCodeCCNET) {
    ...
    connect(CCNetValidator, SIGNAL(emitNominal(int)), this,
            SIGNAL(eNominal(int)));
    connect(CCNetValidator, SIGNAL(emitNominalDuplicate(int)), this,
            SIGNAL(eNominalDuplicate(int)));
    connect(CCNetValidator, SIGNAL(emitAnimateStatus(bool)), this,
            SIGNAL(showHideDialogAnimate(bool)));
    connect(CCNetValidator, SIGNAL(emitReturnNominalStatus(bool)), this,
            SIGNAL(showHideDialogReturnNominal(bool)));
    connect(CCNetValidator, SIGNAL(emitStatus(int, QString)), this,
            SLOT(getStatusFromValidator(int, QString)));
    connect(CCNetValidator, SIGNAL(emitLog(int, QString, QString)),
    ...
    connect(CCNetValidator, SIGNAL(emitFirmwareUpdate(QString)),
            SIGNAL(emitFirmwareUpdate(QString)));
  }

  if (validatorName == ValidatorModel::MeiEBDS) {
    EBDSValidator = new EBDS();
    connect(EBDSValidator, SIGNAL(emitNominal(int)), this,
            SIGNAL(eNominal(int)));
    connect(EBDSValidator, SIGNAL(emitNominalDuplicate(int)), this,
            SIGNAL(eNominalDuplicate(int)));
    connect(EBDSValidator, SIGNAL(emitAnimateStatus(bool)), this,
            SIGNAL(showHideDialogAnimate(bool)));
    connect(EBDSValidator, SIGNAL(emitReturnNominalStatus(bool)), this,
            SIGNAL(showHideDialogReturnNominal(bool)));
    connect(EBDSValidator, SIGNAL(emitStatus(int, QString)), this,
            SLOT(getStatusFromValidator(int, QString)));
    connect(EBDSValidator, SIGNAL(emitLog(int, QString, QString)),
            SIGNAL(emitLog(int, QString, QString)));
...
bool ClassValidator::isItYou(QStringList &comList, QString &validator_name,
                             QString &com_str, QString &validator_coment) {
