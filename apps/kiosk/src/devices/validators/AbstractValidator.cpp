...
void BaseValidatorDevices::setPortName(const QString com_Name) { comName = com_Name; }

void BaseValidatorDevices::setPartNumber(const QString partNumber) { part_number = partNumber; }
