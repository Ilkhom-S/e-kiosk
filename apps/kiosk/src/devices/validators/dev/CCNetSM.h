...
/* \enum ControllerCommands
    ...
    */
    ...
    namespace States
    {
        ...
        /// After a RESET command from the Controller Bill Validator returns the bill and continues initializing.
        ...
        /// Controller to stack or to return bill. If during 10 sec command will not be sent bill will be returned.
