...
bool WatchDogs::sendCommand(QByteArray dataRequest, bool getResponse,
...
bool WatchDogs::isItYou(QStringList &comList, QString &wd_name,
                        QString &com_str, QString &wd_coment) {
