...
class JsInterface : public QObject {
  ...
  public:
    ...
    Q_INVOKABLE
    void gotoPageInsertNominal(QString account, QString accountDesign, QString prvId, QString prvName) {
        emit emitGotoPageInsertNominal(account, accountDesign, prvId, prvName);
    }

    Q_INVOKABLE
    void gotoPageServices(QString group) {
        emit emitGotoPageServices(group);
    }

    Q_INVOKABLE
    void gotoPageInputFromPayment() {
