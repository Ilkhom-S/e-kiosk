...
{
	static QSet<QString> requiredServices = QSet<QString>() << CServices::PluginService;
...
//---------------------------------------------------------------------------
bool HookService::invokeHook(const QString& aMetodName, QGenericArgument aVal0, QGenericArgument aVal1,
							 QGenericArgument aVal2, QGenericArgument aVal3, QGenericArgument aVal4,
							 QGenericArgument aVal5, QGenericArgument aVal6, QGenericArgument aVal7,
							 QGenericArgument aVal8, QGenericArgument aVal9)
{
	bool result = false;
	...
	foreach (SDK::Plugin::IPlugin* plugin, mHooks)
	{
		...
		if (pluginObject != nullptr)
		{
			...
			result = QMetaObject::invokeMethod(pluginObject, aMetodName.toLatin1().data(), Qt::DirectConnection, aVal0,
											   aVal1, aVal2, aVal3, aVal4, aVal5, aVal6, aVal7, aVal8, aVal9) ||
					 result;
		}
	}
