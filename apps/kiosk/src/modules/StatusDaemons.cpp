...
void StatusDaemons::sendStatusToServer(Sender::Data& a_Data) {
    ...
    if (a_Data.firstSend) {
        ...
        auto osInfo =
            QString(
                "<os version=\"%1\" csname=\"%2\" csdversion=\"%3\" "
                "osarchitecture=\"%4\">%5</os>\n")
                .arg(os.value("version").toString(), os.value("csname").toString(),
                     os.value("csdversion").toString(), os.value("osarchitecture").toString(),
        ...
        auto mboardInfo =
            QString("<mboard product=\"%1\" version=\"%2\" serialnumber=\"%3\">%4</mboard>\n")
        ...
        auto diskInfo =
            QString(
                "<disk serialnumber=\"%1\" size=\"%2 GB\" freespace=\"%3 GB\" local_disks=\"%4\" "
                "model=\"%5\">\n"
        ...
        techParames += QString(
            ...
            "</sim>\n"
            "<connection>" +
            a_Data.connection + "</connection>\n" + osInfo + cpuInfo + mboardInfo + ramInfo +
            diskInfo + "</tech_parametrs>\n");
