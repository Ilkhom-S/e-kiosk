...
void SendRequest::setAuthData(const QString token, const QString uuid,
...
void SendRequest::slotReadyRead() {
  ...
  case QNetworkReply::OperationCanceledError: {
    statusError = 5;
    statusErrorComment =
        "Нет ответа от сервера( истёк таймаут ожидания запроса ).";
  } break;
