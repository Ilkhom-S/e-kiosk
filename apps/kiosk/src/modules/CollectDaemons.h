...
class CollectDaemons : public SendRequest {
  ...
  public:
    ...
    QString getHtmlInfoBox(QString &nonCollectPay, int &moneyOutNum, double &moneyOutSum,
                           QString data, QString &collectionId, QString &stackId, QString &trnFrom,
                           QString &trnTo);
  ...
  private:
    ...
    bool sendCollection(QString &trnId, const QString collectionId, QString &collectionIdNext,
    ...
    bool getCollectionInfo(QString collectionId, QString &collectionIdNext, QString &idTrn,
