...
public:
    ...
    QString getHtmlInfoBox(QString &nonCollectPay, int &moneyOutNum, double &moneyOutSum, QString data, QString &collectionId,QString &stackId, QString &trnFrom, QString &trnTo);
...
private:
    ...
    bool sendCollection(QString &trnId, const QString collectionId, QString &collectionIdNext, QString &dateCreate, QString xmlDenom);
    ...
    bool getCollectionInfo(QString collectionId, QString &collectionIdNext, QString &idTrn, QString &dateCreate, QString &denomXml);
    bool parsDenomilSlot(const QString &xmlDenom);
    bool updateMoneyOut(QString collectionId, QString collectionStatus);
    void getXmlForSend(QString &xml, QString cid, QString cidNext, QString sid, QString dateCreate, QString collectDenom, int moneyOutCount, double moneyOutSum, QString trnFrom, QString trnTo);
