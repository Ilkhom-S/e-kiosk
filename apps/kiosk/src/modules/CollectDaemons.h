...
public:
  ...
  QString getHtmlInfoBox(QString &nonCollectPay, int &moneyOutNum,
                         double &moneyOutSum, QString data,
                         QString &collectionId, QString &stackId,
                         QString &trnFrom, QString &trnTo);
  bool getCheckText(QString &text, bool preCheck, QString dateP,
                    QString cid = QString());
...
private:
  ...
  bool sendCollection(QString &trnId, const QString collectionId,
  ...
  bool getTrnOperation(const QString collectId, const QString &cmd,
                       QString &trn);
  bool getMoneyOut(const QString &collectionId, int &numOut, double &sumOut);
  bool getCollectionInfo(QString collectionId, QString &collectionIdNext,
  ...
  void getXmlForSend(QString &xml, QString cid, QString cidNext, QString sid,
                     QString dateCreate, QString collectDenom,
                     int moneyOutCount, double moneyOutSum, QString trnFrom,
                     QString trnTo);
