...
private:
  ...
  bool getActiveCommand(QString &trn, int &cmd, QString &account,
...
private slots:
  ...
  void authResponse(QString resultCode, QString login, QString token,
                    QString message);
  ...
  bool saveAdminAuthData(bool update, QString secretLogin,
  ...
  void deviceSearchResult(int device, int result, QString dev_name,
  ...
  void saveDevice(int deviceId, QString deviceName, QString port,
