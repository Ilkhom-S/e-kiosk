...
void RegistrationDialog::save2BtnReg()
{
	...
	else
	{
		...
		if (ui->editSecretPasswordReg->text() == "")
		{
			...
			//            ui->editSecretPasswordReg->setPlaceholderText("Секретный пароль состоит из 1-30
			//            цифр/букв/знаков.");
		}
		if (ui->editSecretConfirmPasswordReg->text() == "")
		{
			...
			//            ui->editSecretConfirmPasswordReg->setPlaceholderText("Секретный пароль состоит из 1-30
			//            цифр/букв/знаков.");
		}
		return;
	}
