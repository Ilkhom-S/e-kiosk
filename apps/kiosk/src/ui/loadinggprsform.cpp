...
LoadingGprsForm::~LoadingGprsForm() { delete ui; }
...
void LoadingGprsForm::setSimInfo(QString text) { ui->loading_sim_info->setText(text); }

void LoadingGprsForm::setGprsInfo(QString text) { ui->loading_gprs_info->setText(text); }

void LoadingGprsForm::setGprsComment(QString text) { ui->lblcommentInfoGprs->setText(text); }
