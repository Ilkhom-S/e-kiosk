...
IncasaciyaForm::~IncasaciyaForm() { delete ui; }
...
void IncasaciyaForm::btnInterAdminClc() { emit execCommand(IncashCmd::interAdmin); }

void IncasaciyaForm::btnTestPrintClc() { emit execCommand(IncashCmd::testPrint); }

void IncasaciyaForm::btnDoNullingClc() { emit execCommand(IncashCmd::doNullingCheck); }

void IncasaciyaForm::btnCloseClc() { emit execCommand(IncashCmd::closeThis); }

void IncasaciyaForm::setHtmlInfoBox(QString text) { ui->graphicsViewI->setHtml(text); }

void IncasaciyaForm::btnChangePassClc() { emit openDialog(); }
