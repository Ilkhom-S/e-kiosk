...
public:
  ...
  void authResponse(const QString resultCode, const QString token,
...
private:
  ...
  bool saveDevice(int id_device, const QString &name_device,
...
signals:
  ...
  void emitSaveDevice(int deviceId, QString deviceName, QString port,
