...
public slots:
  ...
  void setCheckOnlineResult(QString resultCode, QString status, QString message,
                            QVariantList items);
...
signals:
  ...
  void emit_checkOnline(QString trn, QString prvId, QString account,
                        double amount, QVariantMap extraInfo = QVariantMap());
  ...
  void emit_sendJsonRequest(QJsonObject json, QString url, QString requestName,
                            int method, int timeout,
