...
public:
  ...
  static IConnection *create(const QString &aName, EConnectionTypes::Enum aType,
  ...
  virtual bool
  checkConnection(const CheckUrl &aHost = CheckUrl()) throw(...) = 0;
