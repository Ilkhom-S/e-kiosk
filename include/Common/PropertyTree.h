...
template <>
inline qint64
WStringTranslator<qint64>::get_value(const std::wstring &aValue) const {
  try {
...
template <>
inline std::wstring
WStringTranslator<qint64>::put_value(const qint64 &aValue) const {
...
template <>
inline QString
WStringTranslator<QString>::get_value(const std::wstring &aValue) const {
...
template <>
inline std::wstring
WStringTranslator<QString>::put_value(const QString &aValue) const {
...
template <>
inline ulong
WStringTranslator<ulong>::get_value(const std::wstring &aValue) const {
  try {
...
template <>
inline std::wstring
WStringTranslator<ulong>::put_value(const ulong &aValue) const {
  return QString::number(aValue).toStdWString();
}
...
template <>
inline double
WStringTranslator<double>::get_value(const std::wstring &aValue) const {
  try {
...
template <>
inline std::wstring
WStringTranslator<double>::put_value(const double &aValue) const {
...
template <>
inline std::wstring
WStringTranslator<const char *>::put_value(const char *const &aValue) const {
...
template <>
inline bool
WStringTranslator<bool>::get_value(const std::wstring &aValue) const {
...
template <>
inline std::wstring
WStringTranslator<bool>::put_value(const bool &aValue) const {
...
template <>
inline QTime
WStringTranslator<QTime>::get_value(const std::wstring &aValue) const {
  QString v = QString::fromStdWString(aValue);
...
template <>
inline std::wstring
WStringTranslator<QTime>::put_value(const QTime &aValue) const {
...
template <>
inline qint64
StringTranslator<qint64>::get_value(const std::string &aValue) const {
  try {
    return std::stoll(aValue);
  } catch (...) {
    return 0;
...
template <>
inline std::string
StringTranslator<qint64>::put_value(const qint64 &aValue) const {
...
template <>
inline QString
StringTranslator<QString>::get_value(const std::string &aValue) const {
...
template <>
inline std::string
StringTranslator<QString>::put_value(const QString &aValue) const {
...
template <>
inline ulong
StringTranslator<ulong>::get_value(const std::string &aValue) const {
  try {
    return std::stoul(aValue);
  } catch (...) {
    return 0;
...
template <>
inline std::string
StringTranslator<ulong>::put_value(const ulong &aValue) const {
  return QString::number(aValue).toStdString();
}
...
template <>
inline double
StringTranslator<double>::get_value(const std::string &aValue) const {
  try {
    return std::stod(aValue);
  } catch (...) {
    return 0;
...
template <>
inline std::string
StringTranslator<double>::put_value(const double &aValue) const {
...
template <>
inline std::string
StringTranslator<const char *>::put_value(const char *const &aValue) const {
...
template <>
inline QTime
StringTranslator<QTime>::get_value(const std::string &aValue) const {
  QString v = QString::fromUtf8(aValue.c_str());
...
template <>
inline std::string
StringTranslator<QTime>::put_value(const QTime &aValue) const {
