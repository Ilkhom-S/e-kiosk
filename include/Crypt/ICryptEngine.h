...
public:
    ...
    virtual bool
    exportSecretKey(int aKeyPair, QByteArray &aSecretKey, const QByteArray &aPassword) = 0;

    /// Выгружает закрытый ключ в файл.
    virtual bool
    exportSecretKeyToFile(int aKeyPair, const QString &aFilePath, const QByteArray &aPassword) = 0;
    ...
    virtual bool
    exportPublicKeyToFile(int aKeyPair, const QString &aFilePath, ulong &aSerialNumber) = 0;
