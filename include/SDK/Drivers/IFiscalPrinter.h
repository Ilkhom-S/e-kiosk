    ...
    namespace Driver {
        ...
        class IFiscalPrinter : public IPrinter {
          ...
          public:
            ...
            virtual bool printFiscal(const QStringList &aStrings, const SPaymentData &aPaymentData,
                                     quint32 *aFDNumber = nullptr) = 0;

            /// Получить фискальные теги по номеру документа.
            virtual bool checkFiscalFields(quint32 aFDNumber, TFiscalPaymentData &aFPData,
                                           SDK::Driver::TComplexFiscalPaymentData &aPSData) = 0;
            ...
            virtual bool isFiscalReady(bool aOnline,
                                       EFiscalPrinterCommand::Enum aCommand = EFiscalPrinterCommand::Sale) = 0;
