    ...
    namespace Plugin {
        ...
        class IPluginLoader {
          public:
            ...
            virtual QStringList
            getPluginPathList(const QRegExp &aFilter) const = 0;
            ...
            virtual QVariantMap
            getPluginInstanceConfiguration(const QString &aInstancePath,
                                           const QString &aConfigPath) = 0;
            ...
            /// Удаляет плагин.
            virtual bool
            destroyPluginPtr(const std::weak_ptr<IPlugin> &aPlugin) = 0;
