    ...
    namespace Plugin {
        ...
        class IKernel {
          public:
            ...
            virtual bool
            canConfigurePlugin(const QString &aInstancePath) const = 0;

            /// Возвращает конфигурацию для данной пары плагин-объект.
            virtual QVariantMap
            getPluginConfiguration(const QString &aInstancePath) const = 0;

            /// Сообщает сможет ли сохранить конфигурацию для данной пары
            /// плагин-объект.
            virtual bool
            canSavePluginConfiguration(const QString &aInstancePath) const = 0;

            /// Сохраняет конфигурацию для данной пары плагин-объект.
            virtual bool
            savePluginConfiguration(const QString &aInstancePath,
