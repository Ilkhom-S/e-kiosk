...
//------------------------------------------------------------------------------
/// Фабрика плагинов регистрирует плагины, слинкованные в данной динамической библиотеке и
/// предоставляет внешнему приложению их список и возможность создания. В одной библиотеке может
/// быть только одна фабрика.
...
#pragma endregion
    ...
    /// внешнего хранилища.
    virtual QVariantMap getPluginInstanceConfiguration(const QString &aPath,
