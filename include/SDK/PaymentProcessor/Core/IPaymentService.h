    ...
    namespace PaymentProcessor {
        ...
        class IPaymentService : public QObject {
          ...
          public:
            ...
            virtual bool updatePaymentField(qint64 aPayment, const IPayment::SParameter &aField,
                                            bool aForceUpdate = false) = 0;

            /// Обновление полей платежа.
            virtual bool updatePaymentFields(qint64 aPayment, const QList<IPayment::SParameter> &aFields,
                                             bool aForceUpdate = false) = 0;
            ...
            /// Конвертация переданного платежа к типу aTargetType, поддерживаема этой фабрикой. В случае ошибки
            /// возвращает false.
