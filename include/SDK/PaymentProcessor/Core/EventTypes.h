...
public:
    enum Enum {
        ...
        Warning, /// Сообщение о некритичной ситуации. Попадает в мониторинг в качестве статуса
                 /// терминала.
        Critical, /// Сообщение о критической ситуации. Попадает в мониторинг в качестве статуса
                  /// терминала.
