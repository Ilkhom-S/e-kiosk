        ...
        namespace Humo
        {
            ...
            class Request
            {
              ...
              public:
                ...
                void addRawParameter(const QString &aName, const QVariant &aValue,
                ...
                /// Получение значение параметра из запроса. Если параметр отсутствует возвращается пустой QVariant.
