...
public:
    ...
    virtual bool restorePayment(IPayment *aPayment,
                                const QList<IPayment::SParameter> &aParameters) = 0;
    ...
    /// Конвертация переданного платежа к типу aTargetType, поддерживаемо этой фабрикой. В случае
