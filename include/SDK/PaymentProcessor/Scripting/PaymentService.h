        ...
        namespace Scripting
        {
            ...
            class Provider : public QObject
            {
              ...
              public slots:
                ...
                QString applySecurityFilter(const QString aId, const QString &aValueRaw,
        ...
        return holder.name;                                                                                            \
            ...
            class PaymentService : public QObject
            {
              ...
              public slots:
                ...
                /// Вычислить для активного платежа, без записи результата в параметры платежа, лимиты комиссию для
                /// произвольной суммы
