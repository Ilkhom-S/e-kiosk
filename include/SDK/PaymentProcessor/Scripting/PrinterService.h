...
public slots:
    /// Проверка принтера на возможность печати чека. Если aRealCheck - true, то результат придёт в
    /// сигнале printerChecked.
    ...
    void printReceipt(const QString &aReceiptType,
...
public:
    ...
    void printReceiptExt(const QString &aReceiptType,
                         const QVariantMap &aParameters,
                         const QString &aTemplate,
