...
namespace Tags
{
    ...
    class Engine : public CSpecification<Type::Enum, STagData>
    {
      public:
        ...
        void appendCommon(Type::Enum aType, const QByteArray &aPrefix, const QByteArray &aOpen,
                          const QByteArray &aClose = QByteArray(1, ASCII::NUL));
      ...
      private:
        ...
        void appendByGroup(bool aBitField, Type::Enum aType, const QByteArray &aPrefix, const QByteArray &aOpen,
