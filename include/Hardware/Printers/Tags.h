...
//--------------------------------------------------------------------------------
const QString regExpData =
    QString("%1(.*)%1").arg("\\[(/?[a-z]+)\\]");                 /// Шаблон произвольного тега.
...
public:
    ...
    /// Получить массив байтов, соответствующий набору тегов и направлению тега
...
private:
    ...
    void appendByGroup(bool aBitField,
                       Type::Enum aType,
                       const QByteArray &aPrefix,
                       const QByteArray &aOpen,
                       const QByteArray &aClose);
