...
namespace CSTAR {
    ...
    class BaseMemorySwitchUtils : public ILogable {
      public:
        ...
        bool update(const TMemorySwitchTypes &aSTARMemorySwitchTypes, TMemorySwitches &aMemorySwitches,
        ...
        bool getConfigParameter(ESTARMemorySwitchTypes::Enum aType, const TMemorySwitches &aMemorySwitches,
                                QVariant &aValue);

      protected:
        /// Добавить данные составного параметра мем-свича.
        void add(ESTARMemorySwitchTypes::Enum aParameterType, int aNumber, int aIndex, const QStringList &aDataTypes,
                 const TMSWParameters &aParameters, const QString &aDescription, const TModels &models = TModels());
        void add(ESTARMemorySwitchTypes::Enum aParameterType, int aNumber, int aIndex, const QString &aDataType,
                 const TMSWParameters &aParameters, const QString &aDescription, const TModels &models = TModels());

        /// Заполнить данные параметра мем-свича.
        void fillExcept(TMSWParameters &aParameters, const TMSWSimpleParameters &aKnownParameters,
                        const QString &aExceptValue = "");
        void fillExcept(TMSWParameters &aParameters, const QString &aValue, const QString &aKey,
                        const QString &aExceptValue = "");

        /// Добавить данные булевского параметра мем-свича.
        void add(ESTARMemorySwitchTypes::Enum aParameterType, int aNumber, int aIndex, bool aInvert,
                 const QString &aDataName, const QString &aDescription, const TModels &models = TModels());

        /// Получить из конфигурации значение параметра по ключу и выбранной конфигурации.
        bool getParameterValue(ESTARMemorySwitchTypes::Enum aParameterType, const QVariantMap &aConfiguration,
                               QStringList &aValue);
