...
template <class T> class SerialPOSPrinter : public T
{
  public:
    ...
    SerialPOSPrinter()
    {
        ...
        this->mPortParameters.insert(EParameters::Parity, POSPrinters::TSerialDevicePortParameter()
                                                              << EParity::No << EParity::Even << EParity::Odd);
        this->mPortParameters.insert(EParameters::ByteSize, POSPrinters::TSerialDevicePortParameter() << 8);
        this->mPortParameters.insert(EParameters::RTS, POSPrinters::TSerialDevicePortParameter()
                                                           << ERTSControl::Toggle);
        this->mPortParameters.insert(EParameters::DTR, POSPrinters::TSerialDevicePortParameter()
