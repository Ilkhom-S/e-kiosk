...
template <class T> class SerialPOSPrinter : public T {
  public:
    ...
    SerialPOSPrinter() {
        ...
        mPortParameters.insert(EParameters::ByteSize, POSPrinters::TSerialDevicePortParameter() << 8);
        mPortParameters.insert(EParameters::RTS, POSPrinters::TSerialDevicePortParameter() << ERTSControl::Toggle);
        mPortParameters.insert(EParameters::DTR, POSPrinters::TSerialDevicePortParameter() << EDTRControl::Handshake);
    }
};
