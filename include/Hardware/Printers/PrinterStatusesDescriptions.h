    ...
    class CSpecifications : public DeviceStatusCode::CSpecifications {
      public:
        ...
        CSpecifications() {
            ...
            ADD_PRINTER_WARNING(ControlPaperNearEnd,
            ...
            ADD_PRINTER_WARNING(WrongFWConfiguration,
            ...
            ADD_PRINTER_ERROR(PrinterFRNotAvailable,
        ...
        TStatusCodes getAvailableErrors() {
            ...
            return mStatusCodes - (TStatusCodes()
                                   << OK::PaperInPresenter << OK::MotorMotion << Error::PrinterFRNotAvailable
                                   << DeviceStatusCode::Error::MechanismPosition << DeviceStatusCode::Error::Temperature
