...
namespace BillAcceptorStatusCode {
    ...
    namespace BillOperation {
        ...
        const int Escrow =
            621; /// Принял купюру, и ждет дальнейшего решения: stack или return. Дается информация о купюре.
    ...
    namespace OperationError {
        ...
        const int Communication =
            669; /// Ошибка связи с устройством (CRC, таймаут ожидания пакета либо тех. посылки, внутренние ошибки).
    ...
    namespace MechanicFailure {
        ...
        const int SeparatingMotor = 691; /// Неисправен мотор сепаратора (для купюроприемником с несколькими стекерами).
