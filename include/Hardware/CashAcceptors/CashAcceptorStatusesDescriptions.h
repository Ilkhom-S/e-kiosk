...
#define ADD_CA_STATUS_DATA(                                                                        \
    aStatusType, aStatusCode, aStatus, aWarninglevel, aDescription, aTranslation)                  \
    append(aStatusType::aStatusCode,                                                               \
           SStatusCodeSpecification(SDK::Driver::EWarningLevel::aWarninglevel,                     \
                                    aDescription,                                                  \
                                    aTranslation,                                                  \
                                    SDK::Driver::ECashAcceptorStatus::aStatus))
#define ADD_CA_STATUS(aStatusType, aStatusCode, aStatus, aWarninglevel, aTranslation)              \
    ADD_CA_STATUS_DATA(aStatusType, aStatusCode, aStatus, aWarninglevel, #aStatusCode, aTranslation)
#define ADD_CA_TYPE(aStatusCode, aStatus, aWarninglevel, aTranslation)                             \
    ADD_CA_STATUS(aStatus, aStatusCode, aStatus, aWarninglevel, aTranslation)
#define ADD_CA_SPECIAL(aStatusType, aStatusCode, aWarninglevel, aTranslation)                      \
    ADD_CA_STATUS(aStatusType, aStatusCode, aStatusCode, aWarninglevel, aTranslation)

#define ADD_CA_BILL_OPERATION(aStatusCode)                                                         \
    ADD_CA_STATUS_DATA(                                                                            \
        BillOperation, aStatusCode, BillOperation, OK, "Bill operation - " #aStatusCode, "")
#define ADD_CA_BUSY(aStatusCode) ADD_CA_TYPE(aStatusCode, Busy, OK, "")
#define ADD_CA_OPERATION_ERROR(aStatusCode)                                                        \
    ADD_CA_STATUS_DATA(OperationError,                                                             \
                       aStatusCode,                                                                \
                       OperationError,                                                             \
                       Warning,                                                                    \
                       "Operation error - " #aStatusCode,                                          \
                       "")
#define ADD_CA_WARNING(aStatusCode, aTranslation)                                                  \
    ADD_CA_TYPE(aStatusCode, Warning, Warning, aTranslation)
#define ADD_CA_SENSOR_ERROR(aStatusCode, aTranslation)                                             \
    ADD_CA_STATUS_DATA(                                                                            \
        SensorError, aStatusCode, Error, Error, "Faulted " #aStatusCode " sensor", aTranslation)
...
#define ADD_CA_WARNING(aStatusCode, aTranslation)                                                  \
    ADD_CA_TYPE(aStatusCode, Warning, Warning, aTranslation)
#define ADD_CA_REJECT(aStatusCode)                                                                 \
    ADD_CA_STATUS_DATA(Reject,                                                                     \
                       aStatusCode,                                                                \
                       Rejected,                                                                   \
                       Warning,                                                                    \
                       "Reject by " #aStatusCode,                                                  \
...
public:
    CSpecifications() {
        ...
        ADD_CA_SPECIAL(
            BillOperation, Escrow, OK, QCoreApplication::translate("GeneralStatuses", "#ok"));
        ADD_CA_SPECIAL(
            BillOperation, Stacked, OK, QCoreApplication::translate("GeneralStatuses", "#ok"));
        ADD_CA_SPECIAL(Warning,
                       Cheated,
                       Warning,
                       QCoreApplication::translate("ValidatorStatuses", "#cheating"));
        ADD_CA_SPECIAL(MechanicFailure,
                       StackerFull,
                       Error,
                       QCoreApplication::translate("ValidatorStatuses", "#stacker_full"));
        ADD_CA_SPECIAL(MechanicFailure,
                       StackerOpen,
                       Error,
                       QCoreApplication::translate("ValidatorStatuses", "#stacker_open"));
        ...
        ADD_CA_WARNING(StackerNearFull,
                       QCoreApplication::translate("ValidatorStatuses", "#stacker_near_full"));
        ADD_CA_WARNING(ParInhibitions,
                       QCoreApplication::translate("ValidatorStatuses", "#par_inhibitions"));
        ...
        ADD_CA_MECHANIC_FAILURE(
            JammedInValidator,
            QCoreApplication::translate("ValidatorStatuses", "#jammed_in_validator"));
        ADD_CA_MECHANIC_FAILURE(
            JammedInStacker,
            QCoreApplication::translate("ValidatorStatuses", "#jammed_in_stacker"));
        ADD_CA_MECHANIC_FAILURE(
            StickInExitChannel,
            QCoreApplication::translate("ValidatorStatuses", "#stick_in_exit_channel"));
        ADD_CA_MECHANIC_FAILURE(JammedCoin,
                                QCoreApplication::translate("ValidatorStatuses", "#jammed_coin"));
        ADD_CA_MECHANIC_FAILURE(
            HeadRemoved,
            QCoreApplication::translate("ValidatorStatuses", "#validator_head_removed"));
        ADD_CA_MECHANIC_FAILURE(
            StackerMotor,
            QCoreApplication::translate("ValidatorStatuses", "#stacker_motor_failure"));
        ADD_CA_MECHANIC_FAILURE(
            TransportMotor,
            QCoreApplication::translate("ValidatorStatuses", "#transport_motor_failure"));
        ADD_CA_MECHANIC_FAILURE(
            AligningMotor,
            QCoreApplication::translate("ValidatorStatuses", "#aligning_motor_failure"));
        ADD_CA_MECHANIC_FAILURE(
            SeparatingMotor,
            QCoreApplication::translate("ValidatorStatuses", "#separating_motor_failure"));
        ADD_CA_MECHANIC_FAILURE(
            Stacker, QCoreApplication::translate("ValidatorStatuses", "#stacker_failure"));
        ADD_CA_MECHANIC_FAILURE(
            Stacker1, QCoreApplication::translate("ValidatorStatuses", "#stacker_failure1"));
        ADD_CA_MECHANIC_FAILURE(
            Stacker2, QCoreApplication::translate("ValidatorStatuses", "#stacker_failure2"));
        ADD_CA_MECHANIC_FAILURE(
            Stacker3, QCoreApplication::translate("ValidatorStatuses", "#stacker_failure3"));
        ADD_CA_MECHANIC_FAILURE(
            Stacker4, QCoreApplication::translate("ValidatorStatuses", "#stacker_failure4"));
        ADD_CA_MECHANIC_FAILURE(
            ReturnMechanism,
            QCoreApplication::translate("ValidatorStatuses", "#return_mechanism_failure"));
        ADD_CA_MECHANIC_FAILURE(
            COSMechanism,
            QCoreApplication::translate("ValidatorStatuses", "#COS_mechanism_failure"));
        ADD_CA_MECHANIC_FAILURE(
            DCEChute, QCoreApplication::translate("ValidatorStatuses", "#DCE_chute_failure"));
        ADD_CA_MECHANIC_FAILURE(NoStackers,
                                QCoreApplication::translate("ValidatorStatuses", "#no_stackers"));
        ADD_CA_MECHANIC_FAILURE(
            CoinGateStuck,
            QCoreApplication::translate("ValidatorStatuses", "#coin_gate_stuck_failure"));

        /// Неисправность датчиков, при платеже не может быть потери денег в купюрнике.
        ADD_CA_SENSOR_ERROR(
            Optical,
            QCoreApplication::translate("ValidatorStatuses", "#optical_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Reflective,
            QCoreApplication::translate("ValidatorStatuses", "#reflective_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Magnetic,
            QCoreApplication::translate("ValidatorStatuses", "#magnetic_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Capacitance,
            QCoreApplication::translate("ValidatorStatuses", "#capacitance_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Dielectric,
            QCoreApplication::translate("ValidatorStatuses", "#dielectric_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Credit,
            QCoreApplication::translate("ValidatorStatuses", "#credit_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Piezo, QCoreApplication::translate("ValidatorStatuses", "#piezo_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Diameter,
            QCoreApplication::translate("ValidatorStatuses", "#diameter_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            WakeUp,
            QCoreApplication::translate("ValidatorStatuses", "#wake_up_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Sorter,
            QCoreApplication::translate("ValidatorStatuses", "#sorter_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Dispensing,
            QCoreApplication::translate("ValidatorStatuses", "#dispensing_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Validation,
            QCoreApplication::translate("ValidatorStatuses", "#validation_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Reject,
            QCoreApplication::translate("ValidatorStatuses", "#reject_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Thermo,
            QCoreApplication::translate("ValidatorStatuses", "#thermo_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            String,
            QCoreApplication::translate("ValidatorStatuses", "#string_sensors_are_faulted"));
        ADD_CA_SENSOR_ERROR(
            Rim, QCoreApplication::translate("ValidatorStatuses", "#rim_sensors_are_faulted"));

        /// Ошибка, при платеже не может быть потери денег в купюрнике.
        ADD_CA_ERROR(
            WrongCurrency,
            QCoreApplication::translate("ValidatorStatuses", "#currency_is_not_supported"));
        ADD_CA_ERROR(NoParsAvailable,
                     QCoreApplication::translate("ValidatorStatuses", "#no_pars_available"));
        ADD_CA_ERROR(ParTableLoading,
                     QCoreApplication::translate("ValidatorStatuses", "#par_table_loading"));
        ADD_CA_ERROR(Firmware, QCoreApplication::translate("ValidatorStatuses", "#firmware_error"));
        ADD_CA_ERROR(Clock,
                     QCoreApplication::translate("ValidatorStatuses", "#realtime_clock_error"));
        ADD_CA_ERROR(Calibration,
                     QCoreApplication::translate("ValidatorStatuses", "#calibration_error"));
        ...
        ADD_CA_STATUS_DATA(Reject,
                           ...
                           Warning,
                           "Rejecting",
                           QCoreApplication::translate("ValidatorStatuses", "#rejecting"));
