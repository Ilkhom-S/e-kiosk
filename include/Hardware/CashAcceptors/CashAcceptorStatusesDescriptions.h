...
#define ADD_CA_BILL_OPERATION(aStatusCode)                                                                             \
    ADD_CA_STATUS_DATA(BillOperation, aStatusCode, BillOperation, OK, "Bill operation - " #aStatusCode, "")
...
#define ADD_CA_REJECT(aStatusCode)                                                                                     \
    ADD_CA_STATUS_DATA(Reject, aStatusCode, Rejected, Warning, "Reject by " #aStatusCode,                              \
    ...
    class CSpecifications : public DeviceStatusCode::CSpecifications {
      public:
        CSpecifications() {
            ...
            ADD_CA_SPECIAL(MechanicFailure, StackerFull, Error,
                           QCoreApplication::translate("ValidatorStatuses", "#stacker_full"));
            ADD_CA_SPECIAL(MechanicFailure, StackerOpen, Error,
            ...
            ADD_CA_MECHANIC_FAILURE(ReturnMechanism,
                                    QCoreApplication::translate("ValidatorStatuses", "#return_mechanism_failure"));
            ADD_CA_MECHANIC_FAILURE(COSMechanism,
            ...
            ADD_CA_MECHANIC_FAILURE(CoinGateStuck,
            ...
            ADD_CA_STATUS_DATA(Reject, Rejecting, Rejected, Warning, "Rejecting",
