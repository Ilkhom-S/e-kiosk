...
struct SSensorData {
    ...
    SSensorData() {}
    SSensorData(int aStatusCode, const QString &aAction)
        : statusCode(aStatusCode), action(aAction) {}
};
...
#define ADD_SENSOR_DATA(aSensor)                                                                   \
    append(CHardware::Watchdog::Sensor::aSensor,                                                   \
           SSensorData(WatchdogStatusCode::Warning::aSensor,                                       \
                       CHardware::Watchdog::Sensor::Action::aSensor))
