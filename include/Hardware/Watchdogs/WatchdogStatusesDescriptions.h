/* @file Описатель кодов состояний сторожевых таймеров. */
...
#define ADD_ERROR(aStatusCode, aTranslation)                                                       \
    append(                                                                                        \
        Error::aStatusCode,                                                                        \
        SStatusCodeSpecification(SDK::Driver::EWarningLevel::Error, #aStatusCode, aTranslation))
...
public:
    ...
    CSpecifications() {
        ...
        ADD_WARNING(UPSLowBattery,
                    QCoreApplication::translate("WatchdogSensors", "#ups_low_battery"));
        ...
        ADD_ERROR(PCVoltageBlock,
                  QCoreApplication::translate("WatchdogSensors", "#pc_voltage_block"));
        ADD_ERROR(PCVoltage, QCoreApplication::translate("WatchdogSensors", "#pc_voltage"));
        ADD_ERROR(UPSVoltageBlock,
                  QCoreApplication::translate("WatchdogSensors", "#ups_voltage_block"));
