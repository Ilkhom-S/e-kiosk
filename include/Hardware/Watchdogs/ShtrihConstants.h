...
struct SData {
    ...
    void
    setData(const QString &aName, uchar aAddress, qlonglong aSerial, const SSoftInfo &aSoftInfo) {
        name = aName;
        address = aAddress;
        serial = aSerial;
        softInfo = aSoftInfo;
...
struct SDevicesData {
    ...
    SDevicesData() {
        ...
        devicesData.insert(Devices::Type::General,
                           Devices::SData(All, Constants::BroadcastAddress));
