        ...
        class CDescriptions : public CSpecification<char, SData> {
          public:
            CDescriptions() {
                ...
                append(ModifyInhibitsAndRegesters, EAnswerType::ACK,
                       "modify inhibits and override registers for sequence of coins");
    ...
    class CFault : public CSpecification<uchar, SFault> {
      public:
        CFault() {
            ...
            append(11, DeviceStatusCode::Error::Unknown, "Low level sensor error",
                   "Hopper or tube number"); // ошибка другого устройства
            append(12, DeviceStatusCode::Error::Unknown, "High level sensor error",
                   "Hopper or tube number"); // ошибка другого устройства
            ...
            append(23, DeviceStatusCode::Error::Unknown, "Payout motor fault",
                   "Hopper number"); // ошибка другого устройства
            append(24, DeviceStatusCode::Error::Unknown, "Payout timeout",
                   "Hopper or tube number"); // ошибка другого устройства
            append(25, DeviceStatusCode::Error::Unknown, "Payout jammed",
                   "Hopper or tube number"); // ошибка другого устройства
            append(26, DeviceStatusCode::Error::Unknown, "Payout sensor fault",
                   "Hopper or tube number"); // ошибка другого устройства
            append(27, DeviceStatusCode::Error::Unknown, "Level sensor error",
                   "Hopper or tube number"); // ошибка другого устройства
            append(28, DeviceStatusCode::Error::Unknown,
                   "Personality module not fitted"); // ошибка интеграционного модуля ccTalk: недоступен
            append(29, DeviceStatusCode::Error::Unknown,
                   "Personality checksum corrupted"); // ошибка интеграционного модуля ccTalk: CRC посылки
            append(30, DeviceStatusCode::Error::MemoryStorage, "ROM checksum mismatch");
            append(31, DeviceStatusCode::Error::Unknown, "Missing slave device",
                   "Slave address"); // ошибка slave-устройства - отсутствует
            append(32, DeviceStatusCode::Error::Unknown, "Internal comms bad",
                   "Slave address"); // ошибка slave-устройства - отсутствует
            ...
            append(36, BillAcceptorStatusCode::SensorError::Validation, "Fault on bill validation sensor",
                   "Sensor number");
            ...
            append(48, DeviceStatusCode::Error::Unknown, "Slave device not responding",
                   "Device number"); // ошибка slave-устройства - отсутствует
            ...
            append(51, DeviceStatusCode::Error::MechanicFailure,
                   "Door open"); // скорее всего, ошибка относится к купюроприемнику с дверцей
