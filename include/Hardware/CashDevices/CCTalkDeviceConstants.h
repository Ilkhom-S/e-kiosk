...
public:
    CDescriptions() {
        ...
        append(ModifyInhibitsAndRegesters,
               EAnswerType::ACK,
...
protected:
    void
    add(uchar aError, int aStatusCode, bool aIsRejected = false, const char *aDescription = "") {
...
/// статусы от неподдерживаемых устройств - с комментариями - будут поддержаны при реализации этих
/// устройств
...
public:
    CFault() {
        ...
        append(2,
               BillAcceptorStatusCode::Reject::UserDefined,
        ...
        append(8,
               BillAcceptorStatusCode::SensorError::Sorter,
        ...
        append(14,
               DeviceStatusCode::Error::Unknown,
               "Keypad error",
               "Key number");                                          // ошибка другого устройства
        ...
        append(19,
               BillAcceptorStatusCode::MechanicFailure::ReturnMechanism,
               "Fault on coin return mechanism");
        append(
            20, BillAcceptorStatusCode::MechanicFailure::COSMechanism, "Fault on C.O.S. mechanism");
        ...
        append(36,
               BillAcceptorStatusCode::SensorError::Validation,
        ...
        append(
            42, BillAcceptorStatusCode::MechanicFailure::CoinGateStuck, "Accept gate failed open");
        append(43,
               BillAcceptorStatusCode::MechanicFailure::CoinGateStuck,
        ...
        append(49,
               BillAcceptorStatusCode::SensorError::Optical,
        ...
        append(
            255, DeviceStatusCode::Error::Unknown, "Unspecified fault code", "Further information");
    }
