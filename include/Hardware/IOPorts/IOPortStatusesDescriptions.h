...
public:
    ...
    CSpecifications() {
        ...
        /// Ошибки.
        ADD_ERROR_STATUS(NotConnected,
                         QCoreApplication::translate("IOPortStatuses", "#not_connected"));
        ...
        ADD_ERROR_STATUS(NotConfigured,
                         QCoreApplication::translate("IOPortStatuses", "#not_configured"));
    }
};
} // namespace IOPortStatusCode
