...
struct SData {
    ...
    SData(ETypes::Enum aType, const QString &aTextKey, EClassType::Enum aClassType)
        : type(aType), textKey(aTextKey), translationPF(""), required(ERequired::No),
    ...
    SData(ETypes::Enum aType,
          const QString &aTextKey,
          const QString &aTranslationPF,
