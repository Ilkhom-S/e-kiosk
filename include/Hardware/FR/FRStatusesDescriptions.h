...
public:
    CSpecifications() : mIsFiscal(true) {
        ...
        ADD_FR_WARNING(FiscalMemoryNearEnd,
                       QCoreApplication::translate("FRStatuses", "#FM_near_end"));
        ADD_FR_WARNING(NotFiscalized,
                       QCoreApplication::translate("FRStatuses", "#FR_is_not_fiscalized"));
        ADD_FR_WARNING(ZBufferFull, QCoreApplication::translate("FRStatuses", "#z_buffer_full"));
        ADD_FR_WARNING(OFDNoConnection,
                       QCoreApplication::translate("FRStatuses", "#ofd_no_connection"));
        ...
        ADD_FR_WARNING(
            FirmwareUpdating,
            QCoreApplication::translate("FRStatuses", "#cannot_switch_firmware_autoupdating_on"));
        ADD_FR_WARNING(WrongDealerTaxSystem,
                       QCoreApplication::translate("FRStatuses", "#wrong_dealer_tax_system"));
        ADD_FR_WARNING(WrongDealerAgentFlag,
                       QCoreApplication::translate("FRStatuses", "#wrong_dealer_agent_flag"));
        ADD_FR_WARNING(WrongFiscalizationSettings,
                       QCoreApplication::translate("FRStatuses", "#wrong_fiscalization_settings"));
        ADD_FR_WARNING(WrongTaxOnPayment,
                       QCoreApplication::translate("FRStatuses", "#wrong_tax_on_payment"));
        ADD_FR_WARNING(NeedTimeSynchronization,
                       QCoreApplication::translate("FRStatuses", "#need_time_synchronization"));
        ADD_FR_WARNING(FSVirtualEnd, QCoreApplication::translate("FRStatuses", "#fs_virtual_end"));
        ADD_FR_WARNING(DealerSupportPhone,
                       QCoreApplication::translate("FRStatuses", "#dealer_support_phone"));
        ...
        ADD_FR_ERROR(ZBufferOverflow,
                     QCoreApplication::translate("FRStatuses", "#z_buffer_overflow"));
        ADD_FR_ERROR(NeedCloseSession,
                     QCoreApplication::translate("FRStatuses", "#need_close_session"));
        ADD_FR_ERROR(FSEnd, QCoreApplication::translate("FRStatuses", "#fs_end"));
        ADD_FR_ERROR(NeedOFDConnection,
                     QCoreApplication::translate("FRStatuses", "#need_ofd_connection"));
        ...
        ADD_FR_ERROR(WrongDealerTaxSystem,
                     QCoreApplication::translate("FRStatuses", "#wrong_dealer_tax_system"));
        ADD_FR_ERROR(WrongDealerAgentFlag,
                     QCoreApplication::translate("FRStatuses", "#wrong_dealer_agent_flag"));
