...
namespace CFR
{
    ...
    const TStatusCodes XReportFiscalErrors = getFiscalStatusCodes(SDK::Driver::EWarningLevel::Error)
                                             << DeviceStatusCode::Error::Unknown << FRStatusCode::Error::EKLZ
    ...
    const TPayOffSubjectTypes PayOffSubjectTypesNo36 =
        TPayOffSubjectTypes() << SDK::Driver::EPayOffSubjectTypes::Unit << SDK::Driver::EPayOffSubjectTypes::AgentFee;
