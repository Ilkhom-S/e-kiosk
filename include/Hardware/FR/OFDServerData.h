    ...
    class OFDData : public CSpecification<QString, SOFDData> {
      public:
        OFDData() {
            ...
            add("Platforma", "ofdp.platformaofd.ru", "185.170.204.91", 21101, "ofdt.platformaofd.ru", "185.170.204.85",
                19081);
            add("Yandex", "kkt.ofd.yandex.net", "185.32.186.252", 12345, "test.kkt.ofd.yandex.net", "213.180.204.116",
                12345);
