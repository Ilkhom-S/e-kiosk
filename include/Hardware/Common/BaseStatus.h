...
const int ThirdPartyDriver =
    33; /// Ошибка драйвера стороннего ПО и/или прошивки устройства при
        /// выполнении операции.
...
const int UnknownDataExchange =
    38;                          /// Ошибка при получении данных от устройства.
...
const int MechanismPosition =
    61; /// Внутренний механизм не приведен в рабочее положение.
const int PowerSupply = 62; /// Ошибка электропитания.
const int MemoryStorage =
    63; /// Повреждена микросхема памяти (Flash/RAM/EEPROM).
const int NotAvailable = 64; /// Недоступен.
const int Temperature =
    65; /// Температура не соответствует условиям эксплуатации.
...
const int ThirdPartyDriverFail =
    70; /// Не удается установить связь с драйвером стороннего ПО.
