...
const TResults ProtocolErrors = TResults()
                                << Port << Transport << Protocol << Driver << NoAnswer << Id << CRC;
const TResults PresenceErrors = TResults()
                                << OK << Id << CRC << Answer << Device; // Устройство присутствует.
} // namespace CommandResult
