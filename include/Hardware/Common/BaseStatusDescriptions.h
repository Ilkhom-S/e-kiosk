...
#define ADD_BASE_STATUS(aStatusCode, aTranslation, aWarningLevel)                                                      \
    append(aWarningLevel::aStatusCode,                                                                                 \
           SStatusCodeSpecification(SDK::Driver::EWarningLevel::aWarningLevel, #aStatusCode, aTranslation))
    ...
    class CSpecifications : public TStatusCodeSpecification
    {
      public:
        CSpecifications()
        {
            ...
            ADD_WARNING_STATUS(BootFirmware,
            ...
            ADD_WARNING_STATUS(ThirdPartyDriver,
                               QCoreApplication::translate("GeneralStatuses", "#thirdparty_driver_warning"));
            ADD_WARNING_STATUS(WrongSwitchesConfig,
            ...
            ADD_WARNING_STATUS(UnknownDataExchange,
            ...
            ADD_ERROR_STATUS(MechanismPosition,
            ...
            ADD_ERROR_STATUS(ThirdPartyDriver,
                             QCoreApplication::translate("GeneralStatuses", "#thirdparty_driver_error"));
            ADD_ERROR_STATUS(ThirdPartyDriverFail,
