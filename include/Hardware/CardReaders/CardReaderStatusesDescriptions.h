/* @file Описатель кодов состояний кард-ридеров. */
...
#define ADD_CA_TYPE(aStatusType, aStatusCode, aStatus, aWarninglevel, aDescription, aTranslation)  \
    append(aStatusType::aStatusCode,                                                               \
           SStatusCodeSpecification(SDK::Driver::EWarningLevel::aWarninglevel,                     \
                                    aDescription,                                                  \
                                    aTranslation,                                                  \
                                    SDK::Driver::ECardReaderStatus::aStatus))
#define ADD_CR_STATUS_DATA(aStatusCode, aStatus, aWarninglevel, aDescription, aTranslation)        \
    ADD_CA_TYPE(aStatus, aStatusCode, aStatus, aWarninglevel, aDescription, aTranslation)
#define ADD_CR_STATUS(aStatusCode, aStatus, aTranslation)                                          \
    ADD_CR_STATUS_DATA(aStatusCode, aStatus, aStatus, #aStatusCode, aTranslation)
#define ADD_CR_SPECIAL(aStatusCode, aTranslation)                                                  \
    append(Warning::aStatusCode,                                                                   \
           SStatusCodeSpecification(SDK::Driver::EWarningLevel::Warning,                           \
                                    #aStatusCode,                                                  \
                                    aTranslation,                                                  \
                                    SDK::Driver::ECardReaderStatus::aStatusCode))
...
#define ADD_CR_SC_OPERATION_ERROR(aStatusCode, aTranslation)                                       \
    ADD_CR_STATUS_DATA(                                                                            \
        aStatusCode, SCOperarionError, Warning, "Operation error - " #aStatusCode, aTranslation)
...
public:
    CSpecifications() {
        ...
        ADD_CR_SPECIAL(NeedReloading,
                       QCoreApplication::translate("CardReaderStatuses", "#need_reloading"));

        /// Ошибки при работе со смарт-картой.
        ADD_CR_SC_OPERATION_ERROR(Unknown,
                                  QCoreApplication::translate("CardReaderStatuses", "#unknown"));
        ADD_CR_SC_OPERATION_ERROR(
            Certificate, QCoreApplication::translate("CardReaderStatuses", "#certificate"));
        ADD_CR_SC_OPERATION_ERROR(Security,
                                  QCoreApplication::translate("CardReaderStatuses", "#security"));
        ADD_CR_SC_OPERATION_ERROR(Memory,
                                  QCoreApplication::translate("CardReaderStatuses", "#memory"));
