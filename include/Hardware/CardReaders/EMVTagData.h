...
public:
    CData() {
        ...
        append(0x81, "Amount, Authorized (Binary)");
        ...
        append(0xCA, "Lower cumulative offline transaction amount");
        ...
        append(0xDF40,
               "Message to be displayed by EMV Kernel on “PIN Try Limit Exceeded” condition");
        ...
        append(0xDF891C, "Interact Retry Limit");
        ...
        append(0xDFEF20, "MAC option in response data");
        append(0xDFEF21, "BIN");
        append(0xDFEF22, "AID");
        ...
        append(0xDFEF48,
               "Indicate - retrieve transaction result again due to Output RAM is Not enough");
        ...
        append(0xDFEF70,
               "PISCES dual interface interference prevention mechanism fine-tune parameters");
