...
Application logs are located in the installation directory under `logs/{yyyy.mm.dd}/WatchServiceController.log`, where `{yyyy.mm.dd}` represents the current date in YYYY.MM.DD format.
